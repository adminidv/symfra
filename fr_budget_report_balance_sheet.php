              ...
              <div class="form_sec_action_btn col-md-12">
                ...
                <table  id="calendertable" class="display nowrap no-footer" style="width:100%">
                                                                 ...
                                                                 <thead>
                                                                  ...
                                                                  <tbody>           
                                                                             <tr>
                                                                              <td><select><option>19-20</option></select></td>
                                                                              <td></td> 
                                                                              <td></td>
                                                                              <td></td>           
                                                                              <td></td>           
        ...
        <div class="widget_iner_box">         
               <div class="col-md-6">
                        ...
                        <div class="input-feild input-feild-checkboxs">                                                 
                            ...
                            <input type="radio" name="radiochk" > <label>System Currency </label><br>
                            <input type="radio" name="radiochk" > <label>External Code </label><br>
                            <div class="cls"></div>
                            <hr>
                            <input type="checkbox" name="radiochk" > <label>Ignore Adj.Trans.(period 12) </label><br>
                            <input type="checkbox" name="radiochk" > <label>Accounts with Zero Balance </label><br> 
                            <input type="checkbox" name="chkboxs" > <label>Budget-Relevant Accounts Only</label><br>
                            <input type="checkbox" name="chkboxs" > <label>Foreign Names</label>
                        </div>
               </div> 
                 
                 <div class="col-md-6">
                            <div class="input-feild input-feild-checkboxs">                                                 
                              <input type="checkbox" name="radiochk" > <label>Annual Report  </label><br>
                              <input type="checkbox" name="radiochk" > <label>Quaterly Report  </label><br>
                              <input type="checkbox" name="radiochk" > <label>Monthly Report  </label><br>
