...
$userNo = $_GET['role_ID'];
 $qry= "SELECT * FROM  roles WHERE role_ID = '$userNo'";
  $run= mysqli_query($con , $qry);
  $row = mysqli_fetch_array($run, MYSQLI_ASSOC);

 
    if ($userNo==$row['role_ID'])
    {
      $role_ID= $row['role_ID'];
...
if(isset($_POST['submitBtn']))
{
  ...
  $role_Name = $_POST['role_Name'];
   ...
   $updateQuery = mysqli_query($con, "UPDATE roles SET role_Name='$role_Name'WHERE role_ID='$userNo' ") or die(mysqli_error($con));
		...
		<div class="dpt_form widget_iner_box">
					...
					<div class="cls"></div>
						...
						<div class="col-md-6">
									...
									<div class="input-feild">
										<input  type="text" name="role_Name" required placeholder="Enter Department Title">
