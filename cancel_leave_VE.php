...
if(isset($_POST['submitBtn']))
{
 //  // $empNo = $_POST['empNo'];
  ...
  $updateQuery = mysqli_query($con, "UPDATE leavemanagement SET empID='$empID',leaveType='$leaveType', approvedBy='$approvedBy',leaveReason='$leaveReason',weekDate='$weekDate',hoursTaken='$hoursTaken',can_reason='$can_reason', status ='1' WHERE SrNo='$userNo' ") or die(mysqli_error($con));
		...
		<div class="dpt_form widget_iner_box">
			...
			<div class="dpt_form widget_iner_box">
					...
					<div class="col-md-6">
									...
									<div class="input-feild">
											<textarea name="can_reason" disabled value="<?php echo $can_reason ?>"></textarea>
									</div>
						</div>
			</div>
