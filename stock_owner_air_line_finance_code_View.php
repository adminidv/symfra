				...
				<div class="form_sec_action_btn col-md-12">
				 ...
				 <div class="col-md-6">
                                ...
                                <div class="input-feild"> 
                                       <input type="text" name="owner_name" id="owner_name" class="owner_name" disabled value="<?php echo $owner_name ?>">
                                ...
                                <div class="input-feild">
                                     <select name="owner_country" disabled id="owner_country" class="owner_country" required>
				                         <?php
                                ...
                                <div class="input-feild">
                                      <select name="owner_city" disabled id="owner_city" class="owner_city" required>
				                           <?php
                                ...
                                <div class="input-feild">
                                      <textarea name="owner_add" disabled id="owner_add"><?php echo $owner_add ?></textarea>
                                ...
                                <div class="input-feild">
                                      <input class="mini_input_field" type="text" name="iata_code" id="iata_code" disabled value="<?php echo $iata_code ?>" >
                                       
                                </div>
                                 <div class="input-label"><label >Comm %</label></div>	
                                <div class="input-feild">
                                      <input class="mini_input_field" type="text" name="commesion" id="commesion" disabled value="<?php echo $commesion ?>" ">
                                       
                                </div>

                                 <div class="input-label"><label >WHT </label></div>	
                                <div class="input-feild">
                                    <select class="mini_select_field" disabled name="wht" id="wht">
                                    	<?php echo $wht ?>
                                    	<option>Yes</option>
                                    	<option>No</option>
							...
							<div class="col-md-6">
                                ...
                                <div class="input-feild">
                                       <input  type="text" name="owner_phone" id="owner_phone" disabled placeholder="Phone No." value="<?php echo $owner_phone ?>" >
                                       </div>
                                 <div class="input-label"><label >Fax No. </label></div>	
                                <div class="input-feild">   
                                       <input  type="text" disabled name="fax" id="fax" value="<?php echo $fax ?>" placeholder="Fax No.">

                                </div>
                                <div class="input-label"><label >Email Address</label></div>	
                                <div class="input-feild">
                                       <input  type="text" disabled name="email" id="email" value="<?php echo $email ?>" >
                                </div>
					...
					<hr>
                          ...
                          <div id="menu1" class="tab-pane fade">
                              <div class="container">
                                <br />
                                <div align="right">
                                    <button type="button" disabled id="myBtn1">  <small>Add Stock Owner</small></button>
                                  </div>
