...
<html>
<head>
	<title>Destination Code Setup</title>
								...
								<div class=" widget_iner_box">
											...
											<div class="form_sec_action_btn col-md-12">
											 ...
											 <div class="col-md-6">
			                                                ...
			                                                <div class="input-label"><label >Destination Code</label></div>	
			                                                <div class="input-feild">
			                                                      <input  disabled="" type="text">
			                                                       
			                                                </div>
			                                                
			                                                <div class="input-label"><label >Destination  Name </label></div>	
			                                                <div class="input-feild">
											...
											<div class="col-md-6">
			                                             	<div class="input-label"><label >Sector Code</label></div>	
			                                                <div class="input-feild">
			                                                       <input class="mini_input_field" type="text" name="">
			                                                       <input class="mini_input_field" type="text" disabled="" name="">

			                                                </div>
			                                                <div class="input-label"><label >Country Code</label></div>	
			                                                <div class="input-feild">
			                                                       <input class="mini_input_field" type="text" name="">
			                                                       <input class="mini_input_field" type="text" disabled="" name="">
