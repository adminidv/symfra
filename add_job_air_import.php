                ...
                <table  id="aimport_form_table" class="display nowrap no-footer" style="width:100%">
                         ...
                         <thead>
                          ...
                          <tbody>   
                                   <tr>
                                      <th>MAWB No.</th>
                                      <td> <input class="mini_input_field" type="text" name="m_awb" id="m_awb" maxlength="12"><span class="steric">*</span></td>
                                      <td> <input class="mini_input_field"  type="date" name="m_date" id="m_date"><span class="steric">*</span></td>
                                   ...
                                   <tr>
                                      <th>HAWB No.</th>
                                      <td> <input class="mini_input_field"  type="text" name="h_awb" maxlength="12" id="h_awb"><span class="steric">*</span></td>
                                      <td> <input class="mini_input_field"  type="date" name="h_date" id="h_date"><span class="steric">*</span></td>
