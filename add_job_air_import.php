       ...
       <div class="modal fade confirmTable-modal" id="save_Modal" role="dialog">
        ...
        <div class="widget_iner_box">
              <div class="form_sec_action_btn col-md-12">
                    ...
                    <button type="button" name="btnConfirm_logchange" onclick="logFunc();"> <small>Save</small></button>
                ...
                <table  id="aimport_form_table" class="display nowrap no-footer" style="width:100%">
                         ...
                         <thead>
                          ...
                          <tbody>   
                                   <tr>
                                      <th>MAWB No.</th>
                                      <td> <input class="mini_input_field" type="text" name="m_awb"></td>
                                      <td> <input class="mini_input_field"  type="date" name="m_date"></td>
                                      <td> <select name="m_pp_cc">
                                        <option value="pp">pp</option>
                                        <option value="cc">cc</option>
                                      </select></td>
                                      <td> <input class="mini_input_field"  type="text" name="m_pieces"></td>
                                      <td> <input class="mini_input_field"  type="text" name="m_grs_weight"></td>
                                      <td> <input class="mini_input_field"  class="mini_input_field"  type="text" name="m_ch_weight" id="m_ch_weight"></td>
                                      <td> <input class="mini_input_field" type="text" name="m_rate" id="m_rate" onfocusout="calcDetails_Buy_P();"></td>
                                      
                                   </tr>  

                                   <tr>
                                      <th>HAWB No.</th>
                                      <td> <input class="mini_input_field"  type="text" name="h_awb"></td>
                                      <td> <input class="mini_input_field"  type="date" name="h_date"></td>
                                        <td> <select name="h_pp_cc">
                                        <option value="pp">pp</option>
                                        <option value="cc">cc</option>
                                      </select></td>
                                      <td> <input class="mini_input_field"  type="text" name="h_pieces"></td>
                                      <td> <input class="mini_input_field"   type="text" name="h_grs_weight"></td>
                                      <td> <input class="mini_input_field"  type="text" name="h_ch_weight" id="h_ch_weight"></td>
