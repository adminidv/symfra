...
// msg Alert
  ...
  header("Location: foreign_associate_V1.php?id=" . $viewvar);
}
...
//  insert qurey
 ...
 header("Location: foreign_associate_V1.php?id=" . $viewvar);
  ...
  $viewvar = $_GET['id'];
  $qry= "SELECT * FROM  foreign_associate WHERE code = '$viewvar'";
								...
								<div class=" widget_iner_box">
											...
											<div class="form_sec_action_btn col-md-12">
											 ...
											 <div class="col-md-6">
			                                                ...
			                                                <div class="input-feild">
			                                                        <input   type="text" name="associatename" id="associatename" value="<?php echo $associatename ?>">
