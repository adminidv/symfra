...
else if(isset($_POST["btnEdit"]))
{
  ...
  else
  {
    ...
    echo 'window.location.href = "so_sea_export_table.php";';
    echo '</script>';
  }
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="so_sea_export_table.php" class="btn btn-info active">Sea Export</a>
        </div>
    </div>
  </div>
</div>
