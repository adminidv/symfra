...
if(isset($_POST["btnDelete"]))
{
  ...
  {
    mysqli_query($con, "DELETE FROM department WHERE dept_ID = '$val' ");
  }
}
 ...
 if(isset($_POST["btnExport_D"]))
{
  ...
  {
    header("Location: depttable_excel_U.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "csv")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("depttable_CSV_U.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "pdf")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("depttable_pdf_U.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
}
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">View Department</a>
        </div>
    </div>
  </div>
</div>
...
<div class="leave-manage-sec  main_widget_box ">
      ...
      <div class="form_sec_action_btn col-md-12">
         <div class="form_action_right_btn">
          ...
          <button type="button" id="btnAddEmp" onclick="adddept();">  <small>Add Dept</small></button>
      </div>
        ...
        <div class="tbleDrpdown">
             <div id="tblebtn">
                <ul>
                  ...
                  <li><button type="submit" id="btnExport_P"> <i class="fa fa-print"></i><a href="printtable_dept_U.php?rowDept=<?php echo $rowDept ?>" target="_blank"> Print</a></button></li>
      ...
      <table  id="dpttable" class="display nowrap no-footer" style="width:100%">
                       ...
                       <thead>
                        ...
                        <tr>
                          ...
                          <td><a href="viewdepartmenttable.php?dept_ID=<?php echo $rowDept['dept_ID']; ?>">View</td>
                          <td><a href="editdepartment.php?dept_ID=<?php echo $rowDept['dept_ID']; ?>">Edit</td>
