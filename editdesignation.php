...
$userNo = $_GET['Desig_ID'];
 $qry= "SELECT * FROM  designation WHERE Desig_ID = '$userNo'";
  $run= mysqli_query($con , $qry);
  $row = mysqli_fetch_array($run, MYSQLI_ASSOC);

 
    if ($userNo==$row['Desig_ID'])
    {
...
if(isset($_POST['submitBtn']))
{
  ...
  $Desig_name = $_POST['Desig_name'];
   ...
   $updateQuery = mysqli_query($con, "UPDATE designation SET Desig_name='$Desig_name'WHERE Desig_ID='$userNo' ") or die(mysqli_error($con));
          ...
          <!-- <button type="button" id="btnAddEmp" onclick="adddept();">  <small>Add Dept</small></button> -->
					...
					<div class="cls"></div>
						...
						<div class="col-md-6">
									...
									<div class="input-feild">
										<input  type="text" name="Desig_name" required placeholder="Enter First Name">
