...
$userNo = $_GET['rel_id'];
 $qry= "SELECT * FROM   emprelation WHERE rel_id = '$userNo'";
  $run= mysqli_query($con , $qry);
  $row = mysqli_fetch_array($run, MYSQLI_ASSOC);

 
    if ($userNo==$row['rel_id'])
    {
      $rel_id= $row['rel_id'];
...
if(isset($_POST['submitBtn']))
{
  ...
  $rel_name = $_POST['rel_name'];
   ...
   $updateQuery = mysqli_query($con, "UPDATE emprelation SET rel_name='$rel_name' WHERE rel_id='$userNo' ") or die(mysqli_error($con));
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="rel_table.php" class="btn btn-info active">Add Relation</a>
        </div>
    </div>
  </div>
</div>
