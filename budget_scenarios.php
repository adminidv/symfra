...
<html>
<head>
	<title>Budget Scenarios - Budget</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Budget Scenarios</a>
        </div>
    </div>
  </div>
</div>
            ...
            <div class="modal-dialog">
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class="Bsic_usr_info widget_iner_box">
								...
								<div class="col-md-6">
                                                <div class="input-label"><label >Fiscal Year </label></div>  
              ...
              <div class="widget_iner_box">
                            ...
                            <table  id="budgetscntable" class="display nowrap no-footer" style="width:100%">
