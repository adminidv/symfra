...
<html>
<head>
	<title>Budget Distribution Method</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Budget Distribution Method</a>
        </div>
    </div>
  </div>
</div>
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class="Bsic_usr_info widget_iner_box">
		             ...
		             <div class="col-md-6">
                                                ...
                                                <div class="input-label"><label > Method  </label></div>  
                                                <div class="input-feild">
                                                   <input type="text" name="">
                                                </div>

                                                <div class="input-label"><label > Method Name  </label></div>  
                                                <div class="input-feild">
                                                   <input type="text" name="">
                                                </div>
                                               ...
                                               <div class="input-label"><label > Total  </label></div>  
                                                <div class="input-feild">
                                                   <input disabled="" type="text" name="" placeholder="0.00">
                                                </div>
                 </div>
