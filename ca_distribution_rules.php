  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Distribution Rules</a>
        </div>
    </div>
  </div>
</div>
			...
			<form action="" method="POST" enctype="multipart/form-data">
				       ...
				       <div class="modal fade confirmTable-modal" id="addUser_Modal" role="dialog">
						 ...
						 <label id="formSummary" style="color: red;"></label>
								...
								<div class=" widget_iner_box">
											...
											<div class="form_sec_action_btn col-md-12">
											 ...
											 <div class="col-md-6">
			                                                ...
			                                                <div class="input-label"><label >Effective  </label></div> 
				                                           	<div class="input-feild">
											...
											<div class="col-md-6">
                                                  ...
                                                  <input type="checkbox" name="vehicle" value="Bike"> <label>Direct Allocation</label><br>
                                                  <input type="checkbox" name="vehicle" value="Bike"> <label>Allocate By Fixed Amounts</label>
                                              	</div>
								...
								<div class="widget_iner_box">
									 <table  id="distri_rule_table" class="display nowrap no-footer" style="width:100%">
