...
if(isset($_POST["btnDelete"]))
{
  ...
  {
    mysqli_query($con, "DELETE FROM designation WHERE Desig_ID = '$val' ");
  }
}
 ...
 if(isset($_POST["btnExport_D"]))
{
  ...
  {
    echo '<script type="text/javascript" language="Javascript">window.open("desgtable_CSV_U.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "pdf")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("desgtable_pdf_U.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
}
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">View Designation</a>
        </div>
    </div>
  </div>
</div>
        ...
        <div class="tbleDrpdown">
             <div id="tblebtn">
                <ul>
                  ...
                  <li><button type="submit" id="btnExport_P"> <i class="fa fa-print"></i><a href="printtable_desg_U.php?rowDept=<?php echo $rowDept ?>" target="_blank"> Print</a></button></li>
                       ...
                       <thead>
                        ...
                        <tbody>
                          ...
                          <?php
                                ...
                                ?>
                        <tr>
                          <?php echo '<td><input type="checkbox" name="user_check[]" value="'. $rowDesig['Desig_ID'] .' " /></td>'; ?>
                          <td><?php echo $rowDesig['Desig_ID']; ?></td>
                          <td><?php echo $rowDesig['Desig_name']; ?></td>
                          <td><a href="viewdesignationtable.php?Desig_ID=<?php echo $rowDesig['Desig_ID']; ?>">View</td>
                          <td><a href="editdesignation.php?Desig_ID=<?php echo $rowDesig['Desig_ID']; ?>">Edit</td>
