               ...
               <div class="modal fade confirmTable-modal" id="Edit_Modal" role="dialog">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p>Are You Sure You Want to Submit?</p>
                          <button type="submit" name="btnedit1" onclick="FormValidation()">Yes</button>
                              <button type="button" name="btnDelete_N" data-dismiss="modal" >No</button>
                ...
                <div class=" widget_iner_box">
                      ...
                      <div class="form_sec_action_btn col-md-12">
                       ...
                       <div class="col-md-6">
                                                  ...
                                                  <option ><?php echo $partyname_P  ?></option>
                                                  ...
                                                  ?>
                                                   <?php
                                                      ...
                                                      {
                                                        echo '<option value="'.$rowSub['cmpTitle'].'">'.$rowSub['cmpTitle'].'</option>';
                                                      }
                                                    ?>
                                             ...
                                             <select name="country" id="country" class="country" >
                                                  ...
                                                  <option><?php echo $country_P  ?></option>
                                                  <?php
