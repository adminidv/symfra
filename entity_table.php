...
if(isset($_POST["btnDelete"]))
{
  ...
  {
    mysqli_query($con, "DELETE FROM entity WHERE SrNo = '$val' ");
  }
}
 ...
 if(isset($_POST["btnExport_D"]))
{
  ...
  {
    header("Location: entity_excel.php");
  }
  else if ($exportOptions == "csv")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("entity_csv.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "pdf")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("entity_pdf.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
}
...
<div class="leave-manage-sec  main_widget_box ">
      ...
      <div class="form_sec_action_btn col-md-12">
         <div class="form_action_right_btn">
          ...
          <button type="button" id="btnAddEmp" onclick="adddept();">  <small>Add Entity</small></button>
      </div>
        ...
        <div class="tbleDrpdown">
             <div id="tblebtn">
                <ul>
                  ...
                  <li><button type="submit" id="btnExport_P"> <i class="fa fa-print"></i><a href="entity_print.php" target="_blank"> Print</a></button></li>
                       ...
                       <thead>
                        ...
                        <tbody>
                          <?php
                                  ...
                                  $selectDept = mysqli_query($con, "select * from entity ");
                          ...
                          <?php
                                ...
                                ?>
                        <tr>
                          <?php echo '<td><input type="checkbox" name="user_check[]" value="'. $rowDept['SrNo'] .' " /></td>'; ?>
                          <td><?php echo $rowDept['Tittle']; ?></td>
                          <td><?php echo $rowDept['cont_per_name']; ?></td>
                          <td><?php echo $rowDept['cont_per_no']; ?></td>
                          <td><?php echo $rowDept['desg_name']; ?></td>
                          <td><?php echo $rowDept['city']; ?></td>
                          <td><a href="entity_view.php?SrNo=<?php echo $rowDept['SrNo']; ?>">View</td>
                          <td><a href="entity_edit.php?SrNo=<?php echo $rowDept['SrNo']; ?>">Edit</td>
