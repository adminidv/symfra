			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class="Bsic_usr_info widget_iner_box">
								...
								<div class="col-md-6">
                                                ...
                                                <div class="input-label"><label >Print Checks</label></div>  
                                                <div class="input-feild">
                                                        <select>
                                                ...
                                                <div class="input-feild">
                                                 ...
                                                 <input type="checkbox" name="vehicle" value="Bike"> <label>Open printing settings from default printing layout</label> 
                                                </div>
								</div>

								<div class="col-md-6">
                                                <div class="widget_child_title"><h4>Back Account</h4></div>
                ...
                <div class="col-md-6">
                                                <div class="input-label"><label >Internal ID </label></div>
                                                <div class="input-label"><label >Vendor Code </label></div>
                                                <div class="input-feild">
                                                    <input class="mini_input_field" type="text" name="" placeholder="From">
                                                    <input class="mini_input_field" type="text" name="" placeholder="To">
                                                ...
                                                <div class="input-label"><label>No. of Copies</label></div>
                                                <div class="input-feild">
                                                  <input type="text" name="">
                                                </div>
