...
<html>
<head>
	<title>Customer Open Document List</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="Usermodules.php" class="btn btn-info">Financials Reports</a>
          <a href="Usermodules.php" class="btn btn-info">Accounting</a>
          <a href="hr_add_emp_info.php" class="btn btn-info ">Tax</a>
          <a href="hr_add_emp_info.php" class="btn btn-info  active">Customer Open Document List</a>
            ...
            <div class="modal-dialog">
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class=" widget_iner_box">
								...
								<div class="col-md-6">
                                              <div class="input-label"><label > Open Doc.  By   </label></div>  
                                              ...
                                              <div class="input-label"><label > Date to   </label></div>  
                                              <div class="input-feild">
                ...
                <div class="col-md-6">
                                              <div class="input-label"><label > Recon. Date to </label></div>  
                                              <div class="input-feild">
                                                <input type="text" name="">
                                                ...
                                                <div class="input-feild input-feild-checkboxs">
                                                 <input checked="" type="checkbox" value="Bike"> <label>Customer Code</label>
