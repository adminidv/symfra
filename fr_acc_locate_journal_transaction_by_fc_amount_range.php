...
<html>
<head>
	<title>Locate Journal Transaction by FC Amount Range</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Locate Journal Transaction by FC</a>
        </div>
    </div>
  </div>
</div>
            ...
            <div class="modal-dialog">
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class=" widget_iner_box">
								...
								<div class="col-md-6">
                                              <div class="input-label"><label > Debit Amount <br><small>(Greater or Equal)</small>   </label></div>  
                                              <div class="input-feild">
                                                <input type="text" name="">

                                              </div>

                                              <div class="input-label"><label > Debit Amount <br><small>(Smaller or Equal)</small>   </label></div>  
                                              <div class="input-feild">
                                                <input  type="text" name="">
