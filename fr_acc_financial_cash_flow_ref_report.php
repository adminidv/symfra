...
<html>
<head>
	<title>Cash Flow Reference Report</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Cash Flow Reference Report</a>
        </div>
    </div>
  </div>
</div>
				...
				<div class=" widget_iner_box">
                              ...
                              <hr>
                               <div class="input-feild input-feild-checkboxs">
                                 <input checked="" type="radio" name="radiochk" > <label>Unassigned Transaction Relevant to Cash Flow  </label><br>
                                 <input checked="" type="radio" name="radiochk" > <label>All Transactions Relevant to Cash Flow</label>
                               </div>                   
                </div>
