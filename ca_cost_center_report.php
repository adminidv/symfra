  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Cost Center Report</a>
        </div>
    </div>
  </div>
</div>
...
<div class=" add_customer_sec main_widget_box">
	<div class="">
			...
			<form action="" method="POST">
                      ...
                      <input type="radio" name="chkfrmname" value="chkform1" checked> <label>Template</label>
                  </div>  
                  ...
                  <div class="input-feild input-feild-checkboxs" style="width: 25%;">
                    ...
                    <div class="col-md-6">                                  
				                                           		...
				                                           		<div class="input-label"><label >Summary of  </label></div>
                                                      <div class="input-feild">
                                                            <select>
                                                              <option>Distribution Rules</option>
                                                            </select>
                                                      </div>

				                                           		<div class="input-feild input-feild-checkboxs">
				                                                  <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Project</label>
                                                          <button style="margin: 10px 30px;">...</button><br>
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Exclude Cost Centers with No Posting</label><br>
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Hide Cost Centers with No Posting</label><br>
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Hide Distribution Rules with No Posting</label>
				                                              	</div>
                ...
                <div class=" widget_iner_box">
                    ...
                    <div class="col-md-6">
                                                      <div class="input-label"><label >Sort Date </label></div> 
                                                      <div class="input-feild">
                                                            <input class="mini_input_field" type="text" placeholder="From">
                                                            <input class="mini_input_field" type="text" placeholder="To">
                                                      </div> 
                    ...
                    <div class="col-md-6">                                  
                                                      ...
                                                      <div class="input-feild">
                                                        ...
                                                        <div class="input-feild input-feild-checkboxs">
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Project</label>
                                                          <button style="margin: 10px 30px;">...</button><br>
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Summary Sort by Code</label><br>
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Exclude  Cloesing Balance JE's</label><br>
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Exclude Cost Centers with No Posting</label><br>
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Hide Distribution Rules with No Posting</label>
                                                        </div>
                    </div>
