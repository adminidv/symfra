  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info ">Comparison</a>
...
<div class=" add_customer_sec main_widget_box">
	<div class="">
       ...
       <div class="modal fade confirmTable-modal" id="addUser_Modal" role="dialog">
        ...
        <div class="widget_iner_box">
          <div class="col-md-6">
            <div class="input-label"><label>Company Name <br><small>Current</small></label></div>
            <div class="input-feild">
              <input type="text" name="">
            </div>

            <div class="input-label"><label>Comparison Operator</label></div>
            <div class="input-feild">
              <input type="text" name="">
            </div>
          </div>
           ...
           <div class="col-md-6">
            <div class="input-label"><label>DataBase Name </label></div>
            <div class="input-feild">
              <input type="text" name="">
            </div>
