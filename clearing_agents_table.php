...
if(isset($_POST["btnDelete"]))
{
  ...
  {
    $selectStatus = mysqli_query($con, "SELECT * FROM clearing_agents WHERE SrNo='".$val."' ");
    ...
    {
      mysqli_query($con, "UPDATE clearing_agents SET status='Deactive' WHERE SrNo = '".$val."' ");
    }
    ...
    if(isset($_POST["btnDelete1"]))
{
  ...
  while (list($key, $val) = @each ($id))
  {
    ...
    {
      mysqli_query($con, "UPDATE clearing_agents SET status='Active' WHERE SrNo = '".$val."' ");
    }
 ...
 if(isset($_POST["btnExport_D"]))
{
  ...
  {
    header("Location: clearing_agents_excel.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "csv")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("clearing_agents_csv.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "pdf")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("clearing_agents_pdf.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
}
...
<html>
<head>
  <title>Clearing Agents Table</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="clearing_agents_table.php" class="btn btn-info active">Clearing Agents Table</a>
        </div>
    </div>
  </div>
</div>
    ...
    <div class="">
      <div class="col-md-12">
        <div class="user_create_btn">
          ...
          <button type="button" id="btnNewUser" onclick="newclearing();">Add Clearing Agents</button>
        </div>
      </div>

      <div class="col-md-12">
        <div class="user_table-title">
          <h4>Clearing Agents Table</h4>
        </div>
            ...
            <div class="tbleDrpdown">
               <div id="tblebtn">
                  <ul>
                    ...
                    <li><button type="submit" id="btnExport_P"> <i class="fa fa-print"></i><a href="clearing_print.php" target="_blank"> Print</a></button></li>
                                                  ...
                                                  <tbody>   
                                                    ...
                                                    <?php
                                                         ...
                                                         // fetch data in currency setup
                                                             $selectvar = mysqli_query($con, "select * from  clearing_agents ");
                                                          while ($rowtablevar= mysqli_fetch_array($selectvar))
                                                          {
                                                            
                                                            $id = $rowtablevar['SrNo'];
                                                            $code = $rowtablevar['code'];
                                                            $name = $rowtablevar['name'];
                                                          ...
                                                          ?>        
                                                            ...
                                                            <td><a href="clearing_agents_V.php?id=<?php echo $rowtablevar['SrNo']; ?>">View</td>
                                                            <td><a href="clearing_agents_VE.php?id=<?php echo $rowtablevar['SrNo']; ?>">Edit</td>
                                                             ...
                                                             <?php
                                                              ...
                                                              {
                                                              ?>
                                                              <td><a href="delete_clearing_agent.php?id=<?php echo $rowtablevar['SrNo']; ?>" >Deactive</td>
                                                              <?php
                                                              }
                                                              ?>
                                                              ...
                                                              {
                                                              ?>
                                                              <td><a href="delete_clearing_agentdctv.php?id=<?php echo $rowtablevar['SrNo']; ?>" >Active</td>
                                                              <?php
                                                              }
                                                              ?> 
...
function newclearing() {
  location.replace("clearing_agents.php")
}
</script>
