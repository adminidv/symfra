...
include 'manage/connection.php';
 ...
 $selectsector =  "select * from  sector_setup ";
$select = mysqli_query($con, $selectsector);
...
$iii = 2;
while ($rowsector = mysqli_fetch_array($select))
{
   
    $sector_name = $rowsector['sector_name'];
    $status = $rowsector['status'];
    ...
    $objPHPExcel->getActiveSheet()->getColumnDimension('J')->setWidth(20);*/
     $objPHPExcel ->getActiveSheet() ->setCellValue('A1', 'Sector Name')
    ->setCellValue('B1', 'Status');

    $objPHPExcel ->getActiveSheet() ->setCellValue($a, $sector_name)
