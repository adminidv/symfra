                      ...
                      <form action="usertable.php" method="POST">
                         <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu sidebar-searchbynames  ">
                                  ...
                                  <div class="sidebar-search">
                                    <div class="input-group">
                                      <select name="adv_custName" id="adv_custName">
                                  ...
                                  <div class="sidebar-search">
                                    <div class="input-group">
                                      <select name="adv_currency" id="adv_currency">
                                  ...
                                  <div class="sidebar-search">
                                    <div class="input-group">
                                      <select name="adv_agentParty" id="adv_agentParty">
                                         ...
                                         $selectAP = mysqli_query($con, "SELECT * FROM custmaster");
                                         while ($rowAP = mysqli_fetch_array($selectAP))
                                         {
                                          $agentParty = $rowAP['cmpTitle'];
                                          echo '<option value="'.$agentParty.'">'.$agentParty.'</option>';
                                         }
                                  ...
                                  <div class="sidebar-search">
                                    <div class="input-group">
                                      <select name="adv_foreignParty" id="adv_foreignParty">
                                         <option value="">Select Foreign Agent</option>

                                         <?php

                                         $selectFP = mysqli_query($con, "SELECT * FROM custmaster");
                                         while ($rowFP = mysqli_fetch_array($selectFP))
                                         {
                                          $foreignAgent = $rowFP['cmpTitle'];
                                          echo '<option value="'.$foreignAgent.'">'.$foreignAgent.'</option>';
                                         }
                                  ...
                                  <div class="sidebar-search">
                                    <div class="input-group">
                                      <select name="adv_commodity" id="adv_commodity">
                                        <option value="">Select Commodity</option>

                                        <?php

                                          $selectComm = mysqli_query($con, "select * from pro_setup_commodity");
                                          while ($rowComm = mysqli_fetch_array($selectComm))
                                          {
                                            echo '<option value="'.$rowComm['pro_description'].'">'.$rowComm['pro_description'].'</option>';
                                          }
                                        ?>
                                      </select>
                                    </div>
