                      ...
                      <form action="usertable.php" method="POST">
                         <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu sidebar-searchbynames  ">
                                  ...
                                  <div class="sidebar-search">
                                    <div class="input-group">
                                      <input type="text" class="form-control search-menu" name="adv_MAWBNo" placeholder="Enter MAWB No.">
                                      <div class="input-group-append">
                                        <span class="input-group-text">
                                          <i class="fa fa-search" aria-hidden="true"></i>
                                        </span>
                                  ...
                                  <div class="sidebar-search">
                                    <div class="input-group">
                                      <input type="text" class="form-control search-menu" name="adv_HAWBNo" placeholder="Enter HAWB No.">
                                      <div class="input-group-append">
                                        <span class="input-group-text">
                                          <i class="fa fa-search" aria-hidden="true"></i>
                                        </span>
