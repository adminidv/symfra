	...
	<div class="">
			...
			<form action="" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form_sec_action_btn col-md-12">
                          ...
                          <button type="button" name="submitBtn"> <small>Add Cost Center</small></button>
                          <button type="button" name="submitBtn"> <small>Distribution Rule</small></button>       
                      </div>
								...
								<div class="widget_iner_box">
									 <table  id="distri_rule_table" class="display nowrap no-footer" style="width:100%">
                                             ...
                                             <thead>
                                                        <tr>
                                                          <th>Distr.Rule/ Cost Center</th>
                                                          <th>Fixed Amount Allocation</th>
