...
// auto increment job
$selectLastID = mysqli_query($con, "SELECT * FROM sea_export_entry ORDER BY job_no DESC LIMIT 1");
			 ...
			 <label id="formSummary" style="color: red;"></label>
              ...
              <div class="widget_iner_box">
                ...
                <div class="col-md-6">
                            ...
                            <div class="input-feild chkform2 chkboxform" style="display: none;">
                               <?php echo '<input class="mini_input_field" disabled="" type="text" name="last_con_no" value="'.$lastID.'">'; ?>
                            </div>
 ...
 -->
        ...
        <div class="widget_iner_box">
           <div class="col-md-6">
                  ...
                  <div class="input-feild input-feild-checkboxs"  style="width: 25%;">
                    <input type="radio" name="chkfrmname5" value="chkform9" checked> <label>Select Name</label>
                  </div>  

                  <div class="input-feild input-feild-checkboxs" style="width: 25%;">
                    <input type="radio" name="chkfrmname5" value="chkform10" ><label>Enter Name</label>
                  </div>
                  ...
                  <!-- <div class="cls"></div>
                      ...
                      <div class="input-label"><label>Name </label></div>
                             ...
                             <div class="input-feild chkform9 chkboxform5" >
                              <select class="select_field name" name="name" id="name" ><option></option></select>
                            </div>


                            <div class="input-feild chkform10 chkboxform5" style="display: none;">
                            <input class="input_field name" type="text" name="name" id="name" ></input>
                            </div>
                  ...
                  <div class="input-feild">
                  <textarea name="address_a" id="address_a" class="address_a"></textarea>
                
                  </div>

                  <div class="input-feild input-feild-checkboxs Consignee"  style="width: 25%;">
                    <input type="radio" name="chkfrmname4" value="chkform7" checked> <label>Select Name</label>
                  </div>  

                  <div class="input-feild input-feild-checkboxs" style="width: 25%;">
                    <input type="radio" name="chkfrmname4" value="chkform8" ><label>Enter Name</label>
                  </div>

                  <div class="input-label"><label>Consignee Name </label></div>

                             <div class="input-feild chkform7 chkboxform4" >
                              <select class="select_field consignee_name" name="consignee_name" id="consignee_name" ><option></option></select>
                            </div>


                            <div class="input-feild chkform8 chkboxform4" style="display: none;">
                            <input class="input_field consignee_name" type="text" name="consignee_name" id="consignee_name" ></input>
                            </div>


                  <div class="input-label"><label>Consignee Address</label></div>
                  <div class="input-feild">
                  <textarea name="consignee_address" id="consignee_address" class="consignee_address"></textarea>
          ...
          <div class="col-md-6">
                  ...
                  <div class="input-feild input-feild-checkboxs"  style="width: 25%;">
                    <input type="radio" name="chkfrmname3" value="chkform5" checked> <label>Select Name</label>
                  </div>  

                  <div class="input-feild input-feild-checkboxs" style="width: 25%;">
                    <input type="radio" name="chkfrmname3" value="chkform6" ><label>Enter Name</label>
                  </div>

                  <div class="input-label"><label>Forwarding Agent Name </label></div>

                             <div class="input-feild chkform5 chkboxform3" >
                              <select class="select_field foreign_name" name="foreign_name" id="foreign_name" ><option></option></select>
                            </div>


                            <div class="input-feild chkform6 chkboxform3" style="display: none;">
                            <input class="input_field foreign_name" type="text" name="foreign_name" id="foreign_name" ></input>
                            </div>

                  <div class="input-label"><label>Forwarding Agent Address</label></div>
                  <div class="input-feild">
                  <textarea name="foreign_address" id="foreign_address" class="foreign_address"></textarea>
                
                  </div>

                  <div class="input-label"><label>Notify</label></div>
                  <div class="input-feild">
                  <textarea name="notify" id="notify" class="notify"></textarea>
        ...
        <div class="widget_iner_box">
           ...
           <div class="col-md-6">
                  ...
                  <div class="input-feild input-feild-checkboxs"  style="width: 25%;">
                    <input type="radio" name="chkfrmname2" value="chkform3" checked> <label>Select Name</label>
                  </div>  

                  <div class="input-feild input-feild-checkboxs" style="width: 25%;">
                    <input type="radio" name="chkfrmname2" value="chkform4" ><label>Enter Name</label>
                  </div>

                  <div class="input-label"><label> Delivery Agent Name </label></div>

                             <div class="input-feild chkform3 chkboxform2" >
                              <select class="select_field domestic_routing" name="domestic_routing" id="domestic_routing" ><option></option></select>
                            </div>


                            <div class="input-feild chkform4 chkboxform2" style="display: none;">
                            <input class="input_field domestic_routing" type="text" name="domestic_routing" id="domestic_routing" ></input>
                            </div>

                  <div class="input-label"><label>Delivery Agent Address</label></div>
                  <div class="input-feild">
                  <textarea name="domestic_address" id="domestic_address" class="domestic_address"></textarea>
