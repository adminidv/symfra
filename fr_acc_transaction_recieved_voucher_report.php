...
<html>
<head>
	<title>Transaction Recieved from Voucher Report</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active"> Transaction Recieved from Voucher Report</a>
        </div>
    </div>
  </div>
</div>
            ...
            <div class="modal-dialog">
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class=" widget_iner_box">
								...
								<div class="col-md-6">
                                              <div class="input-label"><label >Journal Voucher No. <br><small>(Equal)</small>   </label></div>  
