    ...
    <thead>
                        ...
                        <tbody>
                          <?php
                                  ...
                                  $selectRole = mysqli_query($con, "select * from   entity ");
                        ...
                        <tr>
                          ...
                          <td><?php echo $rowRole['SrNo']; ?></td>
                          <td><?php echo $rowRole['Tittle']; ?></td>
                          <td><?php echo $rowRole['cont_per_name']; ?></td>
                          <td><?php echo $rowRole['cont_per_no']; ?></td>
                          <td><?php echo $rowRole['desg_name']; ?></td>
                          <td><?php echo $rowRole['city']; ?></td>
                        </tr>
                        <?php
                          }
                          ?>
