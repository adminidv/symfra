  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Reconciliation</a>
        </div>
    </div>
  </div>
</div>
...
<div class=" add_customer_sec main_widget_box">
	<div class="">
			...
			<form action="" method="POST">
								...
								<div class="widget_iner_box">
											...
											<div class="form_sec_action_btn col-md-12">
											 ...
											 <div class="col-md-6">
			                                                ...
			                                                <div class="input-label"><label >G/L Accounts</label></div>	
			                                                <div class="input-feild">
			                                                     <input class="mini_input_field" type="submit" name="" value="Find">
                       ...
                       <table  id="reconcliationtable" class="display nowrap no-footer" style="width:100%">
										...
										<div class="col-md-6">
                                                      ...
                                                      <div class="input-feild">
                                                        ...
                                                        <div class="input-feild input-feild-checkboxs">
                                                          ...
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Exclude Closing Balance JEs</label><br>
                                                          <input type="radio" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Display LC</label><br>
                                                          <input type="radio" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Display SC</label><br>
                                                          <input type="radio" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Display LC & SC</label><br>
                                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Hide Accounts with No Postings</label>
                                                        </div>
