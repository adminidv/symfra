...
include 'manage/connection.php';
 ...
 $selectmop =  "select * from  mop_setup ";
$select = mysqli_query($con, $selectmop);
...
$iii = 2;
while ($rowmop = mysqli_fetch_array($select))
{
   
    $mop_code = $rowmop['mop_code'];
    $mop_description = $rowmop['mop_description'];
    $mop_p_c = $rowmop['mop_p_c'];
    $status = $rowmop['status'];
    ...
    $objPHPExcel ->getActiveSheet() ->setCellValue($a, $mop_code)
    ->setCellValue($b, $mop_description)
    ->setCellValue($c, $mop_p_c)
