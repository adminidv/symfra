...
<html>
<head>
	<title>Customer Recieveable Aging</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active ">Customer Recieveable Aging</a>
        </div>
    </div>
  </div>
</div>
...
<div class=" add_customer_sec main_widget_box">
	<div class="">
			...
			<form action="" method="POST">
                      ...
                      <input type="radio" name="chkfrmname" value="chkform1" checked> <label>Customer</label>
                  </div>  

                  <div class="input-feild input-feild-checkboxs" style="width: 25%;">
                      <input type="radio" name="chkfrmname" value="chkform2" ><label>Sales Employee</label>
                	</div>
                </div>
  					  	<div class="col-md-6">      
                </div>
						...
						<div id="company_form" class="company_form chkform1 chkboxform"  >
                          ...
                          <div class="col-md-6">                                  
                                        ...
                                        <div class="input-feild input-feild-checkboxs">
                                          ...
                                          <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Display Customer with Zero  Balance</label><br>
                                          ...
                                          <div class="cls"></div>
                                          <hr>
                                           <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Consider Connected Vendors</label>
