  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active ">Trial Balance </a>
        </div>
    </div>
  </div>
</div>
       ...
       <div class="modal fade confirmTable-modal" id="addUser_Modal" role="dialog">
        ...
        <div class="widget_iner_box">
                <div class="col-md-6">
                  ...
                  <div class="input-feild input-feild-checkboxs">
                   <input checked="" type="radio" name="radiochk" > <label>Hide Zero Balanced Acct </label><br>
                   <input checked="" type="radio" name="radiochk" > <label>Hide Acct with No Paddings </label><br>
                   <input checked="" type="radio" name="radiochk" > <label>Foreign Names</label><br>
                   <input checked="" type="radio" name="radiochk" > <label>External Code </label><br>
                   <input checked="" type="radio" name="radiochk" > <label>Opening Balance for Period </label><br>
                    ...
                    <input checked="" type="radio" name="radiochk" > <label>Local & System Currency</label><br>
                    </div>
                ...
                <div class="col-md-6">
                  <div class="input-label"><label>Template</label></div>
                   <div class="input-feild">
                    ...
                    <div class="input-feild input-feild-checkboxs">
                     <input checked="" type="radio" name="radiochk" > <label>Show info per Ctrl Acct  </label><br>
                     <div class="cls"></div>
                     <hr>
                     <input checked="" type="radio" name="radiochk" > <label>Annual Report</label><br>
                     <input checked="" type="radio" name="radiochk" > <label>Quaterly Report </label><br>
                      <input checked="" type="radio" name="radiochk" > <label>Monthly Report</label><br>
                      <input checked="" type="radio" name="radiochk" > <label>Periodic Currency</label><br>
                    </div>
                </div>
        </div>            
                    <div class="cls"></div>
        ...
        <div class="widget_iner_box">
            <div class="col-md-6">
                      <div class="input-feild input-feild-checkboxs"> 
                           ...
                           <input checked="" type="checkbox" name="chkbox" > <label>Ignore Adjustments </label><br>
                       ...
                       <input checked="" type="checkbox" name="chkbox" > <button>Expanded </button><br>
