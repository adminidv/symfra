...
$select = mysqli_query($con, "SELECT * FROM custmaster WHERE partyType='vnd' AND userBr='$userBr' ");
...
while ($row= mysqli_fetch_array($select))
{
    ...
    ->setCellValue('S1', 'Rep. Off. Cell')
    ->setCellValue('T1', 'Rep Per. Cell')
    ->setCellValue('U1', 'Rep. Email')
    ...
    ->setCellValue($c, $vndTitle)
    ->setCellValue($d, $vndStreet)
    ->setCellValue($e, $vndCity)
    ->setCellValue($f, $vndCountry)
