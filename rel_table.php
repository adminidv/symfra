...
if(isset($_POST["btnDelete"]))
{
  ...
  {
    mysqli_query($con, "DELETE FROM emprelation WHERE rel_id = '$val' ");
  }
}
 ...
 if(isset($_POST["btnExport_D"]))
{
  ...
  {
    header("Location: rel_excel.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "csv")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("rel_csv.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "pdf")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("rel_pdf.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
}
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="rel_table.php" class="btn btn-info active">Show Employees</a>
        </div>
    </div>
  </div>
</div>
...
<div class="leave-manage-sec  main_widget_box ">
      ...
      <div class="form_sec_action_btn col-md-12">
         <div class="form_action_right_btn">
          ...
          <button type="button" id="btnAddEmp" onclick="adddept();">  <small>Add Relation</small></button>
      </div>
        ...
        <div class="tbleDrpdown">
             <div id="tblebtn">
                <ul>
                  ...
                  <li><button type="submit" id="btnExport_P"> <i class="fa fa-print"></i><a href="rel_print.php" target="_blank"> Print</a></button></li>
                       ...
                       <thead>
                        ...
                        <tbody>
                          <?php
                                  ...
                                  $selectDept = mysqli_query($con, "select * from emprelation ");
                          ...
                          <?php
                                ...
                                ?>
                        <tr>
                          <?php echo '<td><input type="checkbox" name="user_check[]" value="'. $rowDept['rel_id'] .' " /></td>'; ?>
                          <td><?php echo $rowDept['rel_id']; ?></td>
                          <td><?php echo $rowDept['rel_name']; ?></td>
                          <td><a href="rel_view.php?rel_id=<?php echo $rowDept['rel_id']; ?>">View</td>
                          <td><a href="rel_edit.php?rel_id=<?php echo $rowDept['rel_id']; ?>">Edit</td>
