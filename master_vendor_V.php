...
<html>
<head>
	<title>Master Vendor View</title>
						 ...
						 <label id="formSummary" style="color: red;"></label>
								...
								<div class=" widget_iner_box">
											...
											<div class="form_sec_action_btn col-md-12">
													...
													<a id="btnEnable" href="master_vendor_VE.php?vndID=<?php echo $newCode; ?>"> <small>Edit</small></a>				
											</div>
															<div class="cls"></div>
											 ...
											 <div class="col-md-6">
			                                                ...
			                                                <div class="input-feild">
			                                                       <input type="text" name="vndTitle" id="vndTitle" value="<?php echo $vndTitle; ?>" disabled>
			                                                </div>               
								...
								<div class=" widget_iner_box">
										<div class="col-md-6">
																<div class="input-label"><label >Official Address </label></div> 
				                                              	<div class="input-feild">
				                                                      <input type="text" disabled placeholder="Street" name="vndStreet" id="vndStreet" value="<?php echo $vndStreet; ?>">
				                                                      <input type="tex" disabled placeholder="City" name="vndCity" id="vndCity" value="<?php echo $vndCity; ?>">
				                                                      <input type="text" disabled placeholder="Country" name="vndCountry" id="vndCountry" value="<?php echo $vndCountry; ?>">
