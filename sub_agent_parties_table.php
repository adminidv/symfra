...
if(isset($_POST["btnDelete"]))
{
  ...
  {
    $selectStatus = mysqli_query($con, "SELECT * FROM  sub_agents_parties_setup WHERE SrNo='".$val."' ");
    ...
    {
      mysqli_query($con, "UPDATE sub_agents_parties_setup SET status='Deactive' WHERE SrNo = '".$val."' ");
    }
    ...
    if(isset($_POST["btnDelete1"]))
{
  ...
  while (list($key, $val) = @each ($id))
  {
    ...
    {
      mysqli_query($con, "UPDATE sub_agents_parties_setup SET status='Active' WHERE SrNo = '".$val."' ");
    }
 ...
 if(isset($_POST["btnExport_D"]))
{
  ...
  {
    header("Location: sub_agent_parties_setup_excel.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "csv")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("sub_agent_parties_setup_csv.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "pdf")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("sub_agent_parties_setup_pdf.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
}
...
<html>
<head>
  <title>Sub Agents Parties Table</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="usertable.php" class="btn btn-info active">Sub Agent Parties Table</a>
        </div>
    </div>
  </div>
</div>
    ...
    <div class="">
      <div class="col-md-12">
        <div class="user_create_btn">
          ...
          <button type="button" id="btnNewUser" onclick="newclearing();">Add Sub Agent Parties</button>
        </div>
      </div>

      <div class="col-md-12">
        <div class="user_table-title">
          <h4>Sub Agent Parties Table</h4>
        </div>
                              ...
                              <?php
                                   ...
                                   // fetch data in currency setup
                                    ...
                                    while ($rowtablevar= mysqli_fetch_array($selectvar))
                                    {
                                      ...
                                      $id = $rowtablevar['SrNo'];
                                      $partyname = $rowtablevar['partyname'];
                                      $subpartyname = $rowtablevar['subpartyname'];
                                      ...
                                      $export_reg_no = $rowtablevar['export_reg_no'];
                                      $sales_tax_no = $rowtablevar['sales_tax_no'];
                                      $ntn_no = $rowtablevar['ntn_no'];
                                    ...
                                    ?>        
                                      ...
                                      <td><?php echo $export_reg_no; ?></td>
                                      <td><?php echo $sales_tax_no; ?></td>
                                      <td><?php echo $ntn_no; ?></td>
                                      <td><?php echo $status; ?></td>
                                      
                                      <td><a href="sub_agent_setup_View.php?id=<?php echo $rowtablevar['SrNo']; ?>">View</td>
                                      <td><a href="sub_agent_setup_Edit.php?id=<?php echo $rowtablevar['SrNo']; ?>">Edit</td>
                                       <?php
                                        if ($rowtablevar['status'] == "Active")
                                        {
                                        ?>
                                        <td><a href="delete_sub_agent_partiesdctv.php?id=<?php echo $rowtablevar['SrNo']; ?>" >Deactive</td>
                                        <?php
                                        }
                                        ?>
                                        ...
                                        {
                                        ?>
                                        <td><a href="delete_sub_agent_partiesdctv1.php?id=<?php echo $rowtablevar['SrNo']; ?>" >Active</td>
                                        <?php
                                        }
                                        ?> 
