...
<html>
<head>
	<title>G/L Accounts & Business Partners</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active ">G/L Accounts & Business Partners</a>
        </div>
    </div>
  </div>
</div>
				...
				<div class="Bsic_usr_info widget_iner_box">
                 ...
                 <div class="col-md-6"> 
                                                ...
                                                <div class="input-feild input-feild-checkboxs">                                                 
                                                  <input checked="" type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>BP</label><br>
                                                  <input type="checkbox" name="seaImportC" id="seaImportC" value="Sea Import"> <label>Display Leads</label><br>
