  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Journal Voucher Report</a>
        </div>
    </div>
  </div>
</div>
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class="Bsic_usr_info widget_iner_box">
								...
								<div class="col-md-6">
                                                ...
                                                <div class="input-label"><label > Journal Voucher No. </label></div> 
                                                <div class="input-feild">
                                                       <input class="mini_input_field" type="text" name="" placeholder="From">
                                                       <input class="mini_input_field" type="text" name="" placeholder="To">  
                                                </div>

                                                <div class="input-label"><label > Tran. No. </label></div> 
                                                <div class="input-feild">
                                                       <input class="mini_input_field" type="text" name="" placeholder="From">
                                                       <input class="mini_input_field" type="text" name="" placeholder="To">  
                                                </div>
                ...
                <div class="col-md-6">
                                                 ...
                                                 <input checked="" type="checkbox" name="vehicle" value="Bike"> <label>Display Open Journal Voucher</label><br>
                                                 <input checked="" type="checkbox" name="vehicle" value="Bike"> <label>Display Closed Journal Voucher</label>
                                                </div>
                </div>
