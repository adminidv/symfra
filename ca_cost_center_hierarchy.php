...
<html>
<head>
	<title>Cost Center Hierarchy</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Cost Center Hierarchy</a>
        </div>
    </div>
  </div>
</div>
						 ...
						 <label id="formSummary" style="color: red;"></label>
								...
								<div class=" widget_iner_box">
											...
											<div class="form_sec_action_btn col-md-12">
											 ...
											 <div class="col-md-6">
											 				<div class="widget_child_title"><h4>Hierarchy Details</h4></div>
			                                                <div class="input-label"><label >Templates</label></div>	
			                                                ...
			                                                <div class="widget_child_title"><h4>Item Location</h4></div>	
			                                                <div class="input-label"><label >Parent Article</label></div>	
			                                                <div class="input-feild">
			                                                     <select>
			                                                     	<option></option>
			                                                     </select>
			                                                ...
			                                                <div class="input-label"><label >Loc. on Tree</label></div>	
			                                                <div class="input-feild">
			                                                     <select>
			                                                     	<option></option>
			                                                     </select>
											...
											<div class="col-md-6">
			                               				 	...
			                               				 	<div class="widget_child_title"><h4>Item Details</h4></div>
			                                                
			                                                <div class="input-label"><label > Item Name </label></div>	
			                                                <div class="input-feild">
