  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="#" class="btn btn-info active">View User</a>
        </div>
    </div>
  </div>
</div>
  ...
  <div class="">
    ...
    <div class="Bsic_usr_info widget_iner_box">
            ...
            <div class="form_sec_action_btn col-md-12">
               ...
               <button type="button" id="btnDelete" disabled> <small>Edit</small></button>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-feild">
                  <input  type="text" name="user_fName" id="user_fName" disabled maxlength="20" value="<?php echo $user_fName; ?>" placeholder="Enter First Name"><span class="steric">*</span>
                  <input  type="text" name="user_mName" id="user_mName" disabled maxlength="20" value="<?php echo $user_mName; ?>" placeholder="Enter Middle Name">
                  <input  type="text" name="user_lName" id="user_lName" disabled maxlength="20" value="<?php echo $user_lName; ?>" placeholder="Enter Last Name"><span class="steric">*</span>
              </div>

              <div class="input-label"><label > Date of Birth</label></div>
              <div class="input-feild">
                  <input type="date" name="user_DOB" id="user_DOB" disabled data-date-inline-picker="false" data-date-open-on-focus="true" value="<?php echo $user_DOB; ?>" /><span class="steric">*</span>
              </div>
            </div>
            ...
            <div class="col-md-6">
                  ...
                  <div class="input-label"><label > Choose Profile Image</label></div>
                    <div class="input-feild">
                        ...
                        <input type="file" disabled onchange="readURL(this);" name="fileToUpload" id="fileToUpload">
    ...
    <div class="contct_usr_info widget_iner_box">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-feild">
                    <input  type="text" name="user_email" disabled id="user_email" onfocusout="forUsername()" placeholder="Enter an Email Address" value="<?php echo $user_email; ?>"><span class="steric">*</span>
                    <p id="showUName"></p>
                  </div>

                  <div class="input-label"><label >Contact No.</label></div>  
                  <div class="input-feild">
                    <input  type="text" name="user_contact" id="user_contact" disabled value="<?php echo $user_contact; ?>" placeholder="Enter Number"><span class="steric">*</span>
                    <input  type="text" name="emerg_contact" id="emerg_contact" disabled value="<?php echo $emerg_contact; ?>" placeholder="Enter Emergency Number">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-feild">
                    <textarea disabled name="user_address" id="user_address"><?php echo $user_address; ?></textarea>
                  </div>

                  <div class="input-label"><label >Region</label></div>
                  <div class="input-feild">
                    <input type="text" name="user_region" id="user_region" disabled value="<?php echo $user_region; ?>" placeholder="Enter Your Region">
                  </div>

                  <div class="input-label"><label >City</label></div>
                  <div class="input-feild">
                    <select name="city" disabled id="city">
    ...
    <div class="slction_info widget_iner_box">
                <div class="col-md-6">
                  ...
                  <div class="input-feild">
                        <select class="uform_slct_opt" name="dept_ID" disabled id="dept_ID">
                  ...
                  <div class="input-feild">
                        <select class="uform_slct_opt" name="desig_ID" disabled id="desig_ID">
                  ...
                  <div class="input-feild">
                        <select class="uform_slct_opt" name="role_ID" id="role_ID">
                          <option value="<?php echo $role_ID; ?>"><?php echo $role_Name; ?> </option>
                        </select>
                        <button class="slctfrm_btn" onclick="redirect_role()"><i class="fa fa-plus"></i></button>
                  </div>        
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-feild">
                        <select name="Auth_ID" disabled id="Auth_ID">
                          <?php
                  ...
                  <div class="input-feild">
                    <select name="user_manager" disabled id="user_manager">
                      <?php
                  ...
                  <div class="input-feild">
                    <select name="user_status" disabled id="user_status">
                  ...
                  <div class="input-feild act_btn_user">
                    <input type="checkbox" disabled name="user_active" checked id="user_active" />
                  </div>
    ...
    <div class="acount_info widget_iner_box">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-feild">
                      <input type="password" disabled name="user_pswd" id="user_pswd" value="<?php echo $user_pswd; ?>" placeholder="Enter Password" /><span class="steric">*</span>
                      <input type="password" disabled name="confirmPassword" id="confirmPassword" value="<?php echo $user_pswd; ?>" placeholder="Confirm Password" /><span class="steric">*</span>
    ...
    <div class="efctive_dates_info widget_iner_box">
                <div class="col-md-6">  
                  ...
                  <div class="input-feild">
                    <input type="date" disabled name="user_DOJ" id="user_DOJ" value="<?php echo $user_DOJ; ?>" data-date-inline-picker="false" data-date-open-on-focus="true" />
                  </div>
                </div>
                <div class="col-md-6">  
                <div class="input-label"><label >Date Of Leaving</label></div>
                <div class="input-feild">
                  <input type="date" disabled name="user_DOL" id="user_DOL" data-date-inline-picker="false" data-date-open-on-focus="true" />
                </div>
                </div>  
                <div class="col-md-6">
                </div>
