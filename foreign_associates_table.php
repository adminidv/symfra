...
if(isset($_POST["btnDelete"]))
{
  ...
  {
    $selectStatus = mysqli_query($con, "SELECT * FROM foreign_associate WHERE SrNo='".$val."' ");
    ...
    {
      mysqli_query($con, "UPDATE foreign_associate SET status='Deactive' WHERE SrNo = '".$val."' ");
    }
    ...
    if(isset($_POST["btnDelete1"]))
{
  ...
  while (list($key, $val) = @each ($id))
  {
    ...
    {
      mysqli_query($con, "UPDATE foreign_associate SET status='Active' WHERE SrNo = '".$val."' ");
    }
 ...
 if(isset($_POST["btnExport_D"]))
{
  ...
  {
    header("Location: foreign_associate_excel.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "csv")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("foreign_associate_csv.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "pdf")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("foreign_associate_pdf.php?searchRecord=$searchRecord");</script>';
    //header("Location: downloadtableCSV_U.php?searchRecord=$searchRecord");
  }
}
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="usertable.php" class="btn btn-info active">Foreign Associate Table</a>
        </div>
    </div>
  </div>
</div>
    ...
    <div class="">
      <div class="col-md-12">
        <div class="user_create_btn">
          ...
          <button type="button" id="btnNewUser" onclick="newforeignassociate();">Add Foreign Associate</button>
        </div>
      </div>

      <div class="col-md-12">
        <div class="user_table-title">
          <h4>Foreign Associate Table</h4>
        </div>
                                                  ...
                                                  <tbody>   
                                                    ...
                                                    <?php
                                                         ...
                                                         // fetch data in currency setup
                                                             $selectvar = mysqli_query($con, "select * from  foreign_associate ");
                                                          while ($rowtablevar= mysqli_fetch_array($selectvar))
                                                          {
                                                            ...
                                                            $associatename = $rowtablevar['associatename'];
                                                          ...
                                                          ?>        
                                                            ...
                                                            <td><a href="foreign_associates_V.php?id=<?php echo $rowtablevar['SrNo']; ?>">View</td>
                                                            <td><a href="foreign_associates_VE.php?id=<?php echo $rowtablevar['SrNo']; ?>">Edit</td>
                                                             ...
                                                             <?php
                                                              ...
                                                              {
                                                              ?>
                                                              <td><a href="delete_foreign_associate.php?id=<?php echo $rowtablevar['SrNo']; ?>" >Deactive</td>
                                                              <?php
                                                              }
                                                              ?>
                                                              ...
                                                              {
                                                              ?>
                                                              <td><a href="delete_foreign_associatedctv.php?id=<?php echo $rowtablevar['SrNo']; ?>" >Active</td>
                                                              <?php
                                                              }
                                                              ?> 
...
function newforeignassociate() {
  location.replace("foreign_associates.php")
}
</script>
