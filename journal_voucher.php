      			 ...
      			 <label id="formSummary" style="color: red;"></label>
      				...
      				<div class="Bsic_usr_info widget_iner_box">
                            ...
                            <!-- Go back button code ending here -->
      										...
      										<button type="button" name="submitBtn"> Add Journal Entry to New Voucher</button>				
      								</div>
      								...
      								<div class="col-md-6">
                                                      ...
                                                      <div class="input-label"><label >Find</label></div> 
                                                      <div class="input-feild">
                                                            <input class="" type="text" name="">
                                                      </div>  
                                                       <div class="input-feild input-feild-checkboxs">
                                                           <input type="checkbox" name="vehicle"    > <label>Open Only  </label>
                                                       </div>      
                      </div>
                                
                                                      <table  id="jourlvouchr_table" class="display nowrap no-footer" style="width:100%">
