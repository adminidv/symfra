...
if(isset($_POST["btnDelete"]))
{
  ...
  while (list($key, $val) = @each ($id))
  {
    ...
    if ($currentStatus == "Active")
    {
     ...
     header("Location: so_air_import_table.php");
}
...
else if(isset($_POST["btnEdit"]))
{
  ...
  else
  {
    ...
    echo 'window.location.href = "so_air_import_table.php";';
    echo '</script>';
  }
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="so_air_import_table.php" class="btn btn-info active">Air Export</a>
        </div>
    </div>
  </div>
</div>
