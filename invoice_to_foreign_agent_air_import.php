...
<html>
<head>
	<title>Invoices to Foreign Agent (Air Import) </title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="Usermodules.php" class="btn btn-info active">Invoices to Foreign Agent (Air Import)</a>
	...
	<div class="">
       ...
       <div class="modal fade confirmTable-modal" id="addUser_Modal" role="dialog">
        ...
        <div class="widget_iner_box">
              <div class="form_sec_action_btn col-md-12">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-label"><label>Branch Code.</label></div>
                  <div class="input-feild">
                    <input class="mini_input_field" type="text" name="" disabled="">
                  </div>

                  <div class="input-label"><label>Doc. No.</label></div>
                  <div class="input-feild">
                    <input type="text" name="">
                  </div>

                  <div class="input-label"><label>F/Agent Doc No.</label></div>
                  <div class="input-feild">
                    <input type="text" name="">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-label"><label>F/Agent  No.</label></div>
                  <div class="input-feild">
                    <input type="text" name="">
                  </div>
        ...
        <div class="widget_iner_box">         
               <div class="col-md-6">
                      ...
                      <div class="input-label"><label>Selling Rate </label></div>
                      <div class="input-feild">
                        <input class="mini_input_field" type="text">

                      </div>

                      <div class="input-label"><label>Buying Rate</label></div>
                      <div class="input-feild">
                        <input class="mini_input_field" type="text">
                        
                      </div>

                       <div class="input-label"><label>Total Payable</label></div>
                      <div class="input-feild">
      ...
      <div class="widget_iner_box">
           <div class="col-md-6">
                      ...
                      <div class="input-label"><label>Charges </label></div>
                      <div class="input-feild">
                        <input disabled="" class="mini_input_field" type="text" placeholder="Amount in USD">
                        <input disabled="" class="mini_input_field" type="text" placeholder="Amount in PKR">
                     ...
                     <div class="input-label">Bank Detail</div>
                      <div class="input-feild">
                        <textarea></textarea>
                      </div>
                      ...
                      <table id="hawbtable2" class="display nowrap no-footer" style="width:100%">
                        <thead>
                          <tr>
                            <th></th>
                            <th>Air Freight</th>
                            <th><input disabled="" type="text" name=""></th>
                            <th><input disabled="" type="text" name=""></th>
                        ...
                        <tfoot>
                            <td></td>
                            <td>Total Amount  </td> 
                            <td><input disabled="" type="text" name=""></td>
                            <td><input disabled="" type="text" name=""></td>
      ...
      <div class="widget_iner_box">
          ...
          <table id="hawbtable3" class="display nowrap no-footer" style="width:100%">
                        <thead>
                          <tr>
                            <th>Type</th>
                            <th>No.</th>
