...
<div class="container Usertable">
	...
	<!-- 	<div class="col-md-12">
		...
		<div class="col-md-12">
				...
				<input type="text" id="myInputDesig" placeholder="Search here..">
				</div>

				<table class="table table-striped table-bordered" id="myTableDesig">
					        <thead>
					                    <tr>
...
$(document).ready(function(){
 $("#myInputDesig").on("keyup", function() {
   var value = $(this).val().toLowerCase();
   $("#myTableDesig tr").filter(function() {
