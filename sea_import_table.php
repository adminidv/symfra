...
else if(isset($_POST["btnExport_D"]))
{
  ...
  {
    header("Location: airimport_excel.php?searchRecord=$searchRecord");
  }
  else if ($exportOptions == "csv")
  {
    echo '<script type="text/javascript" language="Javascript">window.open("airimport_csv.php?searchRecord=$searchRecord");</script>';
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="sea_import_table.php" class="btn btn-info active">Show Employees</a>
        </div>
    </div>
  </div>
</div>
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                          ...
                          <div class="modal-body">
                              ...
                              if ($d_o_date_AI == 1)
                              {
                                echo '<input type="checkbox" name="cpmStatus_BM" checked> <label>D.O.Date</label> <br>';
                              }
                              else
                              {
                                echo '<input type="checkbox" name="cpmStatus_BM" > <label>D.O.Date</label> <br>';
                              }
		  ...
		  <table  id="usrtble" class="display nowrap no-footer" style="width:100%">
                       ...
                       <thead>
                                ...
                                <tbody>
                                  ...
                                  <td><a href="hr_add_emp_info_UE.php?id=<?php echo $row['SrNo']; ?>">Edit</td>
