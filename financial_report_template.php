...
<html>
<head>
	<title>Financial Report Templates </title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Financial Report Template</a>
        </div>
    </div>
  </div>
</div>
             ...
             <div class="modal fade confirmTable-modal" id="addUser_Modal" role="dialog">
               ...
               <div class=" widget_iner_box">
                    ...
                    <div class="col-md-6">
                             ...
                             <div class="input-label "><label >Report</label></div>
                            ...
                            <div class="widget_child_title"><h4>Template Properties</h4></div>
                            <div class="input-feild input-feild-checkboxs">
                             <input type="checkbox" name="vehicle" value="Bike"> <label>Show Missing Accounts</label>
                            </div>
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="input-label "><label >Account Name</label></div>
                             ...
                             <div class="input-label "><label >Foreign Name</label></div>
                             <div class="input-feild">     
                                <input type="text" name=""> 
                            </div> 
