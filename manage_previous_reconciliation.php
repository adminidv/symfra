...
<html>
<head>
	<title>Manage Previous Reconciliation</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Manage Previous Reconciliation</a>
        </div>
    </div>
  </div>
</div>
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class="Bsic_usr_info widget_iner_box">
		             ...
		             <div class="col-md-6">
                                                ...
                                                <div class="input-label"><label > Previous Reconcialiations for </label></div>  
                 ...
                 <div class="col-md-6">                               
                                                ...
                                                <div class="input-label"><label >G/L Acnt / Bp Code  </label></div> 
                                                <div class="input-feild">
                                                ...
                                                <div class="input-label"><label >Recon. No.</label></div> 
                                                <div class="input-feild ">
                                                    <input class="mini_input_field" type="text" name="" placeholder="From">
                                                    <input class="mini_input_field" type="text" name="" placeholder="To">
                                               </div> 
