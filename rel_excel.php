...
include 'manage/connection.php';
 ...
 $selectRole =  "select * from emprelation ";
...
while ($rowRole = mysqli_fetch_array($select))
{
    ...
    $rel_id = $rowRole['rel_id'];
    $rel_name = $rowRole['rel_name'];
    ...
    $objPHPExcel ->getActiveSheet() ->setCellValue($a, $rel_id)
    ->setCellValue($b, $rel_name);
...
$file = 'test.xlsx';
  ...
  header("Location: viewrelation.php");
}
