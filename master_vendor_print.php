...
// For search result field customization
          ...
          $selectUM = mysqli_query($con, 'SELECT * FROM vndmaster_vm');

          while ($rowUM = mysqli_fetch_array($selectUM))
          {
            // $cmpType_CM = $rowUM['cmpType_CM'];
            $legCode_VM = $rowUM['legCode_VM'];
            $newCode_VM = $rowUM['newCode_VM'];
            $vndTitle_VM = $rowUM['vndTitle_VM'];
            $vndStreet_VM = $rowUM['vndStreet_VM'];
            $vndCity_VM = $rowUM['vndCity_VM'];
            $vndCountry_VM = $rowUM['vndCountry_VM'];
            $telCode_VM = $rowUM['telCode_VM'];
            $telNumber_VM = $rowUM['telNumber_VM'];
            $cmpWebsite_VM = $rowUM['cmpWebsite_VM'];
            $cmpEmail_VM = $rowUM['cmpEmail_VM'];
            $taxType_VM = $rowUM['taxType_VM'];
            $taxNo_VM = $rowUM['taxNo_VM'];
            $seaImport_VM = $rowUM['seaImport_VM'];
            $airImport_VM = $rowUM['airImport_VM'];
            $seaExport_VM = $rowUM['seaExport_VM'];
            $airExport_VM = $rowUM['airExport_VM'];
            $repName_VM = $rowUM['repName_VM'];
            $repDesig_VM = $rowUM['repDesig_VM'];
            $repOffCell_VM = $rowUM['repOffCell_VM'];
            $repPerCell_VM = $rowUM['repPerCell_VM'];
            $repEmail_VM = $rowUM['repEmail_VM'];
            $fnBnkName_VM = $rowUM['fnBnkName_VM'];
            $fnBnkBr_VM = $rowUM['fnBnkBr_VM'];
            $fnCity_VM = $rowUM['fnCity_VM'];
            $fnCountry_VM = $rowUM['fnCountry_VM'];
            $fnIban_VM = $rowUM['fnIban_VM'];
            $fnNonIban_VM = $rowUM['fnNonIban_VM'];
            $fnCrDays_VM = $rowUM['fnCrDays_VM'];
            $fnCrAmount_VM = $rowUM['fnCrAmount_VM'];
            $cmpStatus_VM = $rowUM['cmpStatus_VM'];
          }
                              ...
                              <tbody>
                                ...
                                <?php
                                 ...
                                 include 'manage/connection.php';
                                  ...
                                  $selectRole = mysqli_query($con, "select * from    vndmaster ");
                                ...
                                ?>
                                                ...
                                                $legCode = $row['legCode'];
                                                $newCode = $row['newCode'];
                                                $vndTitle = $row['vndTitle'];
                                                $vndStreet = $row['vndStreet'];
                                                $vndCity = $row['vndCity'];
                                                $vndCountry = $row['vndCountry'];
                                                $telCode = $row['telCode'];
