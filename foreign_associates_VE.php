...
$selectSrNo = mysqli_query($con, "SELECT * FROM foreign_associate ORDER BY SrNo DESC LIMIT 1");
...
// msg Alert
  ...
  header("Location: foreign_associates_VE.php?id=" . $viewvar);
}
...
//  insert qurey
 ...
 header("Location: foreign_associates_VE.php?id=" . $viewvar);
  ...
  $qry= "SELECT * FROM  foreign_associate WHERE SrNo = '$viewvar'";
...
if ($viewvar==$row['SrNo'])

 {
	...
	$code_P	 = $row['code'];
	$associatename_P    = $row['associatename'];
...
if (isset($_POST['submitBtn'])) {
	...
	$website= $_POST['website'];
          ...
          $initQuery = "UPDATE foreign_associate SET SrNo='$SrNo' ";


	// $updateQuery= mysqli_query($con, " UPDATE foreign_associate SET code='$code',associatename='$associatename',country='$country',city='$city',address='$address',phone='$phone',fax='$fax',email='$email',website='$website',status='$status' WHERE SrNo='$viewvar' ");
   ...
   $selectLastID1 = mysqli_query($con, "SELECT * FROM chainlog WHERE record_id = '$SrNo' ORDER BY instance DESC LIMIT 1  ");
          ...
          $initChangeLog .= " VALUES ('$newID1', 'Foreign', '$SrNo', '$createBy', '$createDate', '$loginUser', '$todayDate'";
          ...
          if ($associatename != $associatename_P)
          {
            $initQuery .= ", associatename='$associatename'";
            $initChangeLog2 = ", '$associatename_P', '$associatename') ";
          }
...
<html>
<head>
	<title>View Foreign Associates</title>
...
<!-- <script type="text/javascript">
      $(document).ready(function(){
          ...
          $("#associatename").prop("disabled", true);
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="uusermodules.php" class="btn btn-info">Setups</a>
          <a href="#" class="btn btn-info active">View Foreign Associates </a>
        </div>
    </div>
  </div>
</div>
                  ...
                  <table id="dpttable1" class="display nowrap no-footer" style="width:100%">
                     ...
                     <tbody>
                      <?php
                              ...
                              $selectchainlog = mysqli_query($con, "select * from chainlog where formName = 'Foreign' ");
 ...
 -->
      ...
      <div class="modal fade symfra_popup2" id="btn1" role="dialog">
            <div class="modal-dialog">
             ...
             <p id="V_associatename" style="color: red;"></p>
                          ...
                          <button type="button" name="saveBtn" onclick="logUserFunc();"> <small>Log Chain</small></button>
											 ...
											 <div class="col-md-6">
			                                                ...
			                                                <div class="input-feild">
			                                                        <input   type="text" name="code" id="code" value="<?php echo $code_P ?>"> 
			                                                </div> 
			                                                 <div class="input-label"><label >Associate Name</label></div>
			                                                <div class="input-feild">
			                                                        <input   type="text" name="associatename" id="associatename" maxlength="40"> value="<?php echo $associatename_P ?>"><span class="steric">*</span>
													...
													<div class="input-feild">
								                     <select name="city" id="city" class="city" required>
								                          ...
								                          ?>
			                                                ...
			                                                <div class="input-feild">
			                                                        <textarea name="address" maxlength="50" id="address"><?php echo $address_P; ?></textarea>
								...
								<div class=" widget_iner_box">
										<div class="col-md-6">
			                                                ...
			                                                <div class="input-feild">
			                                                        <input type="text" name="phone" maxlength="14" id="phone" value="<?php echo $phone_P ?>">
			                                                      		
			                                                </div>
			                                                
			                                                <div class="input-label"><label >Fax No.</label></div>
			                                                <div class="input-feild">
			                                                        <input class=""  type="text" name="fax" id="fax" maxlength="14" value="<?php echo $fax_P ?>">
                           ...
                           <thead>
                              ...
                              <tbody>
                                    ...
                                    <tr>
                                          ...
                                          <td><?php echo $associatename_P ?></td>
...
<script type="text/javascript">
   function FormValidation()
   {
    ...
    var re = /\S+@\S+\.\S+/;
      ...
      var associatename=document.getElementById('associatename').value;
     // var email=document.getElementById('email').value;
      ...
      if(associatename == "")
      {
          document.getElementById('associatename').style.borderColor = "red";
          missingVal = 1;
          // summary += "Firstname is required.";
          document.getElementById("V_associatename").innerHTML = "Firstname is required.";
      }
      if(associatename != "")
      {
          document.getElementById('associatename').style.borderColor = "white";
          document.getElementById("V_associatename").innerHTML = "";
