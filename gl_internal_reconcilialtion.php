...
<html>
<head>
	<title>G/L Internal Reconciliation</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">G/L Internal Reconciliation</a>
        </div>
    </div>
  </div>
</div>
				...
				<div class="Bsic_usr_info widget_iner_box">
								...
								<div class="col-md-6">
                                                <div class="widget_child_title"><h4>Report Type</h4></div>    
                                                 ...
                                                 <input checked="" type="radio" name="vehicle" value="Bike"> <label>Manual</label><br>
                                                 <input checked="" type="radio" name="vehicle" value="Bike"> <label>Automatic</label><br>
                                                 <input checked="" type="radio" name="vehicle" value="Bike"> <label>Semi-Automatic</label>
                                                </div>
                </div>

                <div class="col-md-6">
                                               	                                         
                                                <div class="input-label"><label > Recon. Date </label></div>	
                                               ...
                                               <div class="widget_child_title"><h4>Trans. Selection Criteria</h4></div>    
                                                <div class="input-feild input-feild-checkboxs">
                                                 <input checked="" type="checkbox" name="vehicle" value="Bike"> <label>Date</label>
                                               </div> 
