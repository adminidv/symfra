  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Transaction Journal Report</a>
        </div>
    </div>
  </div>
</div>
            ...
            <div class="modal-dialog">
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class=" widget_iner_box">
								...
								<div class="col-md-6">
                              <div class="widget_child_title"><h4>Actual Period</h4></div>
                              <div class="input-label"><label >Actual Period</label></div>  
                ...
                <div class="col-md-6">
                      <div class="widget_child_title"><h4>Previous Period </h4></div>
                      <div class="input-label"><label > Previous Period </label></div>  
                      <div class="input-feild">
                            <select class="mini_select_field">
                                  <option>Posting Date</option>
                            </select>
