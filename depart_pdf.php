     ...
     <tr>
                   ...
                   <tr>
                        ...
                        <tbody>
                          ...
                          <?php
                                $selectdepartment = mysqli_query($con, "select * from department ");
                                while ($rowdepartment = mysqli_fetch_array($selectdepartment))
                                {
                                ?>
                        <tr>
                          
                          <td><?php echo $rowdepartment['dept_ID']; ?></td>
                          <td><?php echo $rowdepartment['dept_name']; ?></td>
                          <td><?php echo $rowdepartment['savedStatus']; ?></td>
                        </tr>
