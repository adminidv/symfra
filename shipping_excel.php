...
include 'manage/connection.php';
 ...
 $selectship =  "select * from  shipping_setup ";
$select = mysqli_query($con, $selectship);
...
while ($rowinv = mysqli_fetch_array($select))
{
    ...
    $ship_code = $rowinv['ship_code'];
    $ship_name = $rowinv['ship_name'];
    ...
    $objPHPExcel    ->getActiveSheet() ->setCellValue($a, $ship_code)
    ->setCellValue($b, $ship_name)
