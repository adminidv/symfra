...
<html>
<head>
	<title>Customer Opportunity</title>
            			 ...
            			 <label id="formSummary" style="color: red;"></label>
            				...
            				<div class="Bsic_usr_info widget_iner_box">
            								...
            								<div class="col-md-6">
                                                            ...
                                                            <div class="input-label"><label >Business Partner Code</label></div>
                                                            ...
                                                            <div class="input-label"><label >Total Amount Invoiced  </label></div>  
                                                            <div class="input-feild">
                                                                    <input  type="text"  disabled placeholder="">
                                                            </div>    
                                                                  
                                                             <div class="input-label"><label >Business Partner Territory  </label></div>  
                                                             <div class="input-feild">
                                                                   <input  type="text"  disabled placeholder="">
                                                             </div>
            								...
            								<div class="col-md-6">
                                                                  ...
                                                                  <input type="checkbox" name="vehicle" value="Bike"> <label>Sales</label><br>
                                                                  <input type="checkbox" name="vehicle" value="Bike"> <label>Purchasing</label>
                                                            </div>
                                                               
                                                                <div class="cls"></div>
                                                                <hr>

                                                            <div class="input-label"><label >Opportunity Name</label></div>
                                                            <div class="input-feild">
                                                                      <input disabled type="text">
                                                            </div>

                                                            <div class="input-label"><label >Opportunity No. </label></div>
                                                            <div class="input-feild">
                                                                      <input disabled type="text">
                                                            </div>
                                                            ...
                                                            <div class="input-label"><label >starting Date  </label></div>  
                                                            <div class="input-feild">
                                                            ...
                                                            <div class="input-label"><label >Closing %</label></div>  
                                                            <div class="input-feild">
                                                                    <input  type="text"  disabled placeholder="">
                                                            </div>

                                                            <div class="input-feild input-feild-checkboxs">
                                                                  <input type="checkbox" name="vehicle" value="Bike"> <label>Display In System Currency</label>
                            ...
                            <div class="col-md-12"> 
                                                  <ul class="nav nav-tabs">
                                                    <li class="active"><a data-toggle="tab" href="#potential">Potential</a></li>
                                            ...
                                            <div class="tab-content">
                                                    ...
                                                    <div id="potential" class="tab-pane fade in active">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-label"><label >Predicted Closing In </label></div>
                                                            <div class="input-feild">
                                                                      <input class="mini_select_field" disabled type="text">
                                                            ...
                                                            <div class="input-label"><label >Predicted Closing Date</label></div>
                                                            <div class="input-feild">
                                                                      <input disabled type="text">
                                                            </div>
                                                                  
                                                            <div class="input-label"><label >Potential Amount</label></div>
                                                            <div class="input-feild ">
                                                                   <input disabled type="text">
                                                            </div> 

                                                            <div class="input-label"><label >Weighted Amount  </label></div>  
                                                            <div class="input-feild">
                                                            ...
                                                            <div class="input-label"><label >Gross Profit Total</label></div>  
                                                            <div class="input-feild">
                                                                    <input  type="text"  disabled placeholder=" 0.00">
                                                            </div>
                                                    ...
                                                    <div id="general" class="tab-pane fade">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-label"><label >Channel Code</label></div>
                                                            <div class="input-feild">
                                                                      <input  type="text">
                                                            </div>
                                                                  
                                                            <div class="input-label"><label > Channel Name</label></div>
                                                            <div class="input-feild ">
                                                                   <input  type="text">
                                                            </div> 

                                                            <div class="input-label"><label >Channel Contact  </label></div>  
                                                            <div class="input-feild">
                                                                    <select  name="empGender" id="empGender">
                                                                            <option > </option>
                                                                            <option > </option>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-label"><label >Information Source</label></div>
                                                            <div class="input-feild ">
                                                                   <select  name="empGender" id="empGender">
                                                                            <option > </option>
                                                                            <option > </option>
                                                            ...
                                                            <div class="input-label"><label >Industry  </label></div>  
                                                            <div class="input-feild">
                                                                    <select  name="empGender" id="empGender">
                                                                            <option > </option>
                                                                            <option > </option>
                                                    ...
                                                    <div id="stages" class="tab-pane fade">
                                                    		<table  id="Campaigntable2" class="display nowrap no-footer" style="width:100%">
                                                                        ...
                                                                        <th>Owner</th>                                            
                                                                          ...
                                                                          <td></td>
                                                                          <td></td>
                                                                          <td><button><i class="fa fa-arrow-right"></i></button></td>
                                                                          <td></td>
