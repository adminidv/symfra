  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">1099/1096 Report</a>
        </div>
    </div>
  </div>
</div>
	...
	<div class="">
       ...
       <div class="modal fade confirmTable-modal" id="addUser_Modal" role="dialog">
            <div class="modal-dialog">
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class="Bsic_usr_info widget_iner_box">
								...
								<div class="col-md-6">
                                                <div class="widget_child_title"><h4>Report Type</h4></div>    
                                                 <div class="input-feild input-feild-checkboxs">
                                                 <input checked="" type="radio" name="radiochk" > <label>1099 Vendor Summary Report </label><br>
                                                 <input checked="" type="radio" name="radiochk" > <label>1099 Summary by Form/Box Report </label><br>
                                                 <input checked="" type="radio" name="radiochk" > <label>1099 Form</label><br>
                                                 
                                                 <div class="cls"></div>
                                                 <hr>
                                                 <input checked="" type="radio" name="radiochk" > <label>1096 Form</label><br>
                                                 <input checked="" type="radio" name="radiochk" > <label>1099 Boxes</label>
                ...
                <div class="col-md-6">
                                                ...
                                                <div class="input-feild input-feild-checkboxs">
                                                 <input checked="" type="radio" name="radiochk" > <label>Show Not Submitted  </label><br>
                                                 <input checked="" type="radio" name="radiochk" > <label>Show Submitted</label><br>
                                                 <div class="cls"></div>
                                                 <hr>
                                                 <input checked="" type="checkbox" name="input-feild-checkboxs" > <label>Include Payments Which Are Not  Based on Invoices</label><br>
                                                 <input checked="" type="checkbox" name="chkbox" > <label>Include Vendors with 1099 Amount Lower than Required </label>
        ...
        <div class="widget_iner_box">
            <div class="col-md-6">
                    <div class="input-label"><label >Vendor </label></div> 
                    ...
                    <div class="input-feild">
                           ...
                           <input class="mini_input_field" type="submit" value="Properties">

                    </div>
            </div>        
            <div class="col-md-6">
                    <div class="input-label"><label >Posting Date From </label></div> 
                    <div class="input-feild">
                           <input class="mini_input_field" type="text" name="" placeholder="From">
                           <input class="mini_input_field" type="text" name="" placeholder="To">
