...
include 'manage/connection.php';
 ...
 $selectcurrency =  "select * from container_setup ";
...
while ($rowcurrency = mysqli_fetch_array($select))
{
    ...
    $objPHPExcel->getActiveSheet()->getColumnDimension('J')->setWidth(20);*/
     $objPHPExcel ->getActiveSheet() ->setCellValue('A1', 'Container Name')
    ->setCellValue('B1', 'Status');

    $objPHPExcel ->getActiveSheet() ->setCellValue($a, $name)
