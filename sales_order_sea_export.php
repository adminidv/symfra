...
<html>
<head>
	<title>Sales Order(Sea Export)</title>
...
<div class="page-wrapper symfra_theme toggled">
 ...
 <nav id="sidebar" class="sidebar-wrapper">
        <div class="sidebar-content">
           ...
           <?php include 'sidebar_widgets/se_advanced_search_widget.php'; ?>
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <!-- <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> -->
                   ...
                   <p id="V_saleCBM" style="color: red;"></p>
                   ...
                   <p id="V_shipLine" style="color: red;"></p>
                   ...
                   <p id="V_saleTotal" style="color: red;"></p>
            				...
            				<div class="Bsic_usr_info widget_iner_box">
            								...
            								<div class="form_sec_action_btn col-md-12">
            										...
            										<button type="button" id="btnConfirm_Su" onclick="FormValidation(); return false;"> <small>Submit</small></button>
                                  ...
                                  <button type="button" name="submitBtn"> <small>Cancel</small></button>        
            								...
            								<div class="col-md-6">
                                                            ...
                                                            <div class="input-feild">
                                                                    <input  type="text" placeholder="" name="conRef" id="conRef" class="conRef" maxlength="30">
                                                            </div>    
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div style="clear: both"><button type="submit">Submit</button></div>
                        </div>
                        <div class="modal-footer">
                            <p>Add Related content if needed</p>
                          <!-- <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> -->
                                         ...
                                         <select name="shipLine" id="shipLine" class="shipLine">
                                          <option value="">Select </option>
                                                        <?php
                                                          ...
                                                          {
                                                            echo '<option value="'.$rowShipLine['ship_name'].'">'.$rowShipLine['ship_name'].'</option>';
                                                          }
                                                        ?>
                                                </select><span class="steric">*</span>
                                    </div>
...
<script type="text/javascript">
   function FormValidation()
   {
      ...
      var shipLine=document.getElementById('shipLine').value;
      var totalBefDisc=document.getElementById('totalBefDisc').value;
      var saleDisc=document.getElementById('saleDisc').value;
      var saleTax=document.getElementById('saleTax').value;
      ...
      if(shipLine == "")
      {
          document.getElementById('shipLine').style.borderColor = "red";
          missingVal = 1;
          // summary +=  " CNIC number is required ";
          document.getElementById("V_shipLine").innerHTML = "Shipline required.";
      }
      if(shipLine != "")
      {
          document.getElementById('shipLine').style.borderColor = "white";
          document.getElementById("V_shipLine").innerHTML = "";
      }
