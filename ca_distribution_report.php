  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Distribution Report</a>
        </div>
    </div>
  </div>
</div>
	...
	<div class="">
			...
			<form action="" method="POST">
                    ...
                    <div class="col-md-6">                                  
                                                      ...
                                                      <hr>
                                                      <div class="input-feild input-feild-checkboxs">    
                                                          <input type="checkbox" name="radiobox"> <label>Hide Cost Center with No Value</label><br>
                                                          <input type="checkbox" name="radiobox"> <label>Exclude Closing Balance JEs</label><br>
				                                              </div>
