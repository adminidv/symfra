 ...
 foreach($result as $row)
 {
  ...
  <tbody>
    <tr>
     ...
     <td><button type="button" class="edit" disabled id="'.$row["image_id"].'">Edit</button></td>
     <td><button type="button" class="delete" disabled id="'.$row["image_id"].'" data-image_name="'.$row["image_name"].'">Delete</button></td>
    </tr>
    </tbody>
  ';
 }
