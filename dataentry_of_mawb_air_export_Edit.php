...
$userNo = $_GET['id'];
  ...
  $row = mysqli_fetch_array($run, MYSQLI_ASSOC);
    ...
    else
    {
     ...
     $qry2= "SELECT * FROM duecarriers WHERE SrNo = '$userNo'";
...
if (isset($_POST['submitBtn'])) {
  ...
  $carrier_payable =$_POST['carrier_payable'];
  $scanning_payable =$_POST['scanning_payable'];
  $agent_payable =$_POST['agent_payable'];
  $rcp =$_POST['rcp'];
 ...
 // insert query
   ...
   $insertquery = mysqli_query($con," UPDATE air_export_entry SET so_no='$so_no',job_no_a='$job_no_a',job_date_a='$job_date_a',mawb_no='$mawb_no',awb_no='$awb_no',sale_date='$sale_date',owner_name='$ownerID',charge_code='$charge_code',charge_type='$charge_type',booking_date='$booking_date',station='$station',party='$party',agent_party='$agent_party',party_name='$party_name',party_address='$party_address',con_consolidation='$con_consolidation',con_name='$con_name',con_address='$con_address',airport_dep='$airport_dep',airport_to_a='$airport_to_a',airport_to_b='$airport_to_b',airport_to_c='$airport_to_c',airport_by_a='$airport_by_a',airport_by_b='$airport_by_b',airport_by_c='$airport_by_c',currency='$currency',destination='$destination',account_no='$account_no',flight_no_a='$flight_no_a',flight_no_a_date='$flight_no_a_date',form_e_no='$form_e_no',form_e_date='$form_e_date',flight_no_b='$flight_no_b',flight_no_b_date='$flight_no_b_date',ship_inv_no='$ship_inv_no',ship_inv_no_date='$ship_inv_no_date',job_no='$job_no',insurance='$insurance',decl_val_carriage='$decl_val_carriage',decl_val_custom='$decl_val_custom',nominaton='$nominaton',handling_info='$handling_info',other_info='$other_info',account_info='$account_info',said_chain='$said_chain',ref_no='$ref_no',td_flash='$td_flash',clearing_agent='$clearing_agent',spo='$spo',freight='$freight',due_carrier='$due_carrier',due_agent='$due_agent',awb_total='$awb_total',payable_airline='$payable_airline',status_type='$status_type' WHERE SrNo='$SrNo' ") or die(mysqli_error($con));

     // $insertquery2 = mysqli_query($con, "insert into air_export_weight_info (mawb_no,rcp,commision,pcs,grs_weight,cl,commodity,volLength,volWidth,volHeight,volWeight,ch_weight,rate,total_freight) values ('$mawb_no','$rcp','$commision','$pcs','$grs_weight','$cl','$commodity','$volLength','$volWidth','$volHeight','$volWeight','$ch_weight','$rate','$total_freight')") or die(mysqli_error($con));

     $insertquery2 = mysqli_query($con," UPDATE air_export_weight_info SET rcp='$rcp',commision='$commision',pcs='$pcs',grs_weight='$grs_weight',cl='$cl',commodity='$commodity', volLength='$volLength',volWidth='$volWidth', volHeight='$volHeight',volWeight='$volWeight', rate='$rate',total_freight='$total_freight' WHERE  mawb_no='$mawb_no' ") or die(mysqli_error($con));

    // $insertquery3 = mysqli_query($con,"insert into duecarries (mawb_No,totalCarrier,totalCAA,totalAWC,secCharges,secDD,totalSec,fuelCharges,fuelDD,totalFuel,scanCharges,scanDD,totalScan,carrier_payable,scanning_payable,agent_payable) values ('$mawb_No','$totalCarrier','$totalCAA','$totalAWC','$secCharges','$secDD','$totalSec','$fuelCharges','$fuelDD','$totalFuel','$scanCharges','$scanDD','$totalScan','$carrier_payable','$scanning_payable','$agent_payable')") or die(mysqli_error($con));
    $insertquery3 = mysqli_query($con, " UPDATE duecarries SET totalCarrier='$totalCarrier',totalCAA='$totalCAA',totalAWC='$totalAWC',secCharges='$secCharges',secDD='$secDD',totalSec='$totalSec',fuelCharges='$fuelCharges',fuelDD='$fuelDD',totalFuel='$totalFuel',scanCharges='$scanCharges',scanDD='$scanDD',totalScan='$totalScan',carrier_payable='$carrier_payable',scanning_payable='$scanning_payable',agent_payable='$agent_payable' WHERE mawb_No='$mawb_No' ") or die(mysqli_error($con));
    ...
    // $insertquery4 = mysqli_query($con,"insert into dueagentairexp (mawb_No,awaFee,awaCharges,awaPrint) values ('$mawb_No','$awaFee','$awaCharges','$awaPrint') ") or die(mysqli_error($con));
     ...
     $insertquery4 = mysqli_query($con," UPDATE dueagentairexp SET awaFee='$awaFee',awaCharges='$awaCharges',awaPrint='$awaPrint' WHERE mawb_No='$mawb_No' ") or die(mysqli_error($con));
       ...
       <!-- Volumatic popup-->
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="input-fields">    
                              <label>Length</label>
                              <input type="text" name="volLength" id="volLength" value="<?php echo $volLength ?>" placeholder="Enter Length">        
                            </div>
                            <div class="input-fields">    
                              <label>Width</label>
                              <input type="text" name="volWidth" id="volWidth" value="<?php echo $volWidth ?>" placeholder="Enter Width">        
                            </div>
                           <div class="input-fields">    
                              <label>Height</label>
                              <input type="text" name="volHeight" id="volHeight" value="<?php echo $volHeight ?>" onfocusout="calcVolume();" placeholder="Enter Height">        
                            </div>
                             <div class="input-fields">    
                              <label>Volumatic Weight</label>
                              <input type="text" name="volWeight" id="volWeight" value="<?php echo $volWeight ?>" placeholder="Volumetic Weight">        
                            </div>
              ...
              <div class="form_sec_action_btn col-md-12">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-feild">
                    <input type="text" name="so_no" value="<?php echo $so_no ?>" >
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-feild">
                    <input type="date" name="job_date_a" value="<?php echo $job_date_a?>">
                  </div>

                    <div class="input-label"><label>AWB Date.</label></div>
                  <div class="input-feild">
                    <input type="date" name="awb_no" value = "<?php echo $awb_no?>">
                  </div>
                ...
                <div class="col-md-6">  
                  ...
                  <div class="input-feild">
                    <input type="date" name="sale_date" value="<?php echo $sale_date?>">
                  </div>
                  ...
                  <div class="input-feild">
                   <select class="mini_select_field charge_code" name="charge_code" id="charge_code" required onchange="checkValues()" ="">
                    ...
                    <input  class="mini_input_field charge_type"  type="text" name="charge_type" id="charge_type" value="<?php echo $charge_type  ?>">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-feild">
                    <input type="date" name="booking_date" value= "<?php echo $booking_date ?>" >
                  </div>
        ...
        <div class="widget_iner_box">         
              <div class="col-md-6">
                      ...
                      <div class="input-feild">
                        ...
                        <input  class="input_field party_name" type="text" name="party_name" id="party_name" value="<?php echo $party_name?>" >
                      </div>

                      <div class="input-label"><label>Address</label></div>
                      <div class="input-feild">
                        <textarea name="party_address" class="party_address" id="party_address"
              ...
              <div class="col-md-6">
                      ...
                      <div class="input-feild">
                       <select class="mini_select_field" name="con_consolidation"value="<?php echo $con_consolidation?>" >
                         <option>No</option>
                         <option>Yes</option>
                      ...
                      <div class="input-feild">
                        ...
                        <input  class="input_field " class="con_name" type="text" name="con_name" id="con_name" value="<?php echo $con_name?>"  >
                      </div>

                      <div class="input-label"><label>Address</label></div>
                      <div class="input-feild">
                          <textarea name="con_address" id="con_address" class="con_address"
        ...
        <div class="widget_iner_box">         
              <div class="col-md-6">
                      ...
                      <div class="input-feild">
                        <input class="mini_input_field" type="text" name="account_no" value="<?php echo $account_no?>"   >
                      </div>

                       <div class="input-label"><label>Nomination</label></div>
                      <div class="input-feild">
                        <select class="mini_select_field" ="" name="nominaton" id="nominaton" class="nominaton" >
              ...
              <div class="col-md-6">        
                      ...
                      <div class="input-feild">
                        <input class="mini_input_field" type="text" name="flight_no_a" value="<?php echo $flight_no_a?>" >
                        
                      </div>

                      <div class="input-label"><label>Flight No.2</label></div>
                      <div class="input-feild">
                        <input class="mini_input_field" type="text" name="flight_no_b" value="<?php echo $flight_no_b?>" >
                      ...
                      <div class="input-feild">
                        <input  type="text" name="form_e_no" value="<?php echo $form_e_no?>"  >
                        
                      </div>

                      <div class="input-label"><label>Ship Inv. No.</label></div>
                      <div class="input-feild">
                        <input  type="text" name="ship_inv_no" value="<?php echo $ship_inv_no ?>" >
                        
                      </div>

                      <div class="input-label"><label>Job No</label></div>
                      <div class="input-feild">
                        <input class="mini_input_field" type="text" name="job_no" value="<?php echo $job_no?>" >
                        
                      </div>

                      <div class="input-label"><label>Insurance</label></div>
                      <div class="input-feild">
                        <input class="" type="text" name="insurance" value="<?php echo $insurance?>"  >
              ...
              <div class="col-md-6">        
                      ...
                      <div class="input-feild">
                        <input  type="text" name="flight_no_a_date" value="<?php echo $flight_no_a_date?>" >
                        
                      </div>

                      <div class="input-label"><label>Date</label></div>
                      <div class="input-feild">
                        <input  type="text" name="flight_no_b_date" value="<?php echo $flight_no_b_date?>" >
                      </div>

                      <div class="input-label"><label>Date</label></div>
                      <div class="input-feild">
                        <input  type="text" name="form_e_date" value="<?php echo $form_e_date?>">
                      </div>

                      <div class="input-label"><label>Date</label></div>
                      <div class="input-feild">
                        <input  type="text" name="ship_inv_no_date" value="<?php echo $ship_inv_no_date?>">
                      </div>

                      <div class="input-label"><label>Declared Val Carriage</label></div>
                      <div class="input-feild">
                        <input  type="text" name="decl_val_carriage" value="<?php echo $decl_val_carriage?>">
                      </div>

                      <div class="input-label"><label>Declared Val Customs</label></div>
                      <div class="input-feild">
                        <input  type="text" name="decl_val_custom" value="<?php echo $decl_val_custom?>">
                      </div>
        ...
        <hr>  
            ...
            <table id="chrgestable" class="display nowrap no-footer" style="width:100%">
                  ...
                  <tbody>
                   <tr>
                      <td></td> 
                      <td></td>
                      <td><input class="mini_input_field" type="text" name="pcs" id="pcs" value="<?php echo $pcs?>" ></td>
                      <td><input class="mini_input_field" type="text" name="grs_weight" id="grs_weight" value="<?php echo $grs_weight?>"></td>
                      <td><input class="mini_input_field" type="text" name="cl" id="cl" value="<?php echo $cl?>"></td>
                      <td>
                        <select class="mini_select_field" name="commodity" id="commodity" required >
                      ...
                      <td><input class="mini_input_field" type="text" name="ch_weight" id="ch_weight" value="<?php echo $ch_weight?>"></td>
                      <td><input class="mini_input_field" type="text" name="rate" id="rate" onfocusout="calcFreight();" value="<?php echo $rate?>"></td>
                      <td><input class="mini_input_field" type="text" name="total_freight" id="total_freight"value="<?php echo $total_freight?>"></td>
                    </tr>
         ...
         <hr> 
              ...
              <div class="col-md-6">
                ...
                <div class="input-label"><label>Handling Information</label></div>
                <div class="input-feild"><textarea name="handling_info"><?php echo $handling_info ?></textarea></div>

                <div class="input-label"><label>Accounting Information</label></div>
                <div class="input-feild"><textarea name="account_info"><?php echo $account_info ?></textarea></div>
              ...
              <div class="col-md-6">
                 ...
                 <div class="input-feild"><textarea name="other_info"><?php echo $other_info ?></textarea></div>

                <div class="input-label"><label>Said To Contain</label></div>
                <div class="input-feild"><textarea name="said_chain"><?php echo $said_chain ?></textarea></div>
         ...
         <div class="widget_iner_box">
           ...
           <div class="col-md-4">
                ...
                <div class="input-feild"><input type="text" name="ref_no" value="<?php echo $ref_no ?>"></div>  

                <div class="input-label"><label>Td Flash.</label></div>
                <div class="input-feild"><input type="text" name="td_flash" value="<?php echo $td_flash ?>"></div> 
           ...
           <div class="col-md-4">
             ...
             <div class="input-feild">
               <input type="text" name="freight" id="freight" value="<?php echo $freight?>">
             </div>

            <div class="input-label"><label>Due Carrier</label></div>
             <div class="input-feild">
               <input type="text" name="due_carrier" id="due_carrier"value="<?php echo $due_carrier?>">
             </div>


            <div class="input-label"><label>Due Agent</label></div>
             <div class="input-feild">
               <input type="text" name="due_agent" id="due_agent" value="3000"value="<?php echo $due_agent?>">
             </div>

            <div class="input-label"><label>AWB Total</label></div>
             <div class="input-feild">
               <input type="text" name="awb_total" id="awb_total"value="<?php echo $awb_total?>">
             </div>


             <div class="input-label"><label>Payable to Airline</label></div>
             <div class="input-feild">
               <input type="text" name="payable_airline" id="payable_airline"value="<?php echo $payable_airline?>">
             </div>
              ...
              <div id="dueagent" class="tab-pane fade in ">
                ...
                <div class="col-md-12">
                 ...
                 <table id="dueagent_table" class="display nowrap no-footer" style="width:100%">
                    ...
                    <tbody>
                      <tr>
                        <td><input class='mini_input_field' type='text' name='awaFee1' id='awaFee1' value='AWA Fee'value="<?php echo $awaFee1?>"></td>
                        <td><input class='mini_input_field' type='text' name='awaCharges1' id='awaCharges1' value='3000'value="<?php echo $awaCharges1?>"></td>
                        <td><input class='mini_input_field' type='text' name='awaPrint1' id='awaPrint1'value="<?php echo $awaPrint1?>"></td>
                      </tr>
                    </tbody>
                 </table>

                <div class="input-label"><label>Total</label></div>
                <div class="mini-input-feild"><input type="text" name="totalAWA" clas="totalAWA" id="totalAWA"value="<?php echo $totalAWA?>"></div>  
...
$(document).on('click', '.editData', function(){  
  var employee_id = $(this).attr("id"); 
      ...
      $.ajax({
         url:"fatch_airExport.php",  
                method:"GET",  
                data:{employee_id:employee_id},  
                dataType:"json",  
         success: function(data) {
              $('#dest_SrNoV').val(data.SrNo);  
              $('#dest_codeV').val(data.dest_code);  
              $('#dest_nameV').val(data.dest_name);  
