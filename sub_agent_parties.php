...
if (isset($_POST['submitBtn'])) {
	...
	$ntn_no= $_POST['ntn_no'];
			...
			$insertQuery = mysqli_query($con, "insert into  sub_agent_parties_setup (partyname, subpartyname, country, city, address, phone, fax, email, website, export_reg_no, sales_tax_no, ntn_no, status) values  ('$partyname', '$subpartyname',  '$country', '$city','$address', '$phone', '$fax', '$email', '$website', '$export_reg_no', '$sales_tax_no', '$ntn_no', '$status')") or die( mysqli_error($con));
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="sub_agent_parties.php" class="btn btn-info active">Sub Agent Parties</a>
        </div>
    </div>
  </div>
</div>
											 ...
											 <div class="col-md-6">
			                                                ...
			                                                <div class="input-feild">
			                                                     <select name="partyname" id="partyname">
			                                                     	<option value="saad" >saad jafri</option>
			                                                     </select>
			                                                </div> 
			                                                 <div class="input-label"><label >Sub Party Name</label></div>
			                                                <div class="input-feild">
			                                                        <input   type="text" name="subpartyname" id="subpartyname">
								...
								<div class="widget_iner_box">
									<div class="col-md-6">
												<div class="input-label"><label >Export Reg. No  </label></div> 
                                              	<div class="input-feild">
                                              		<input type="text" name="export_reg_no" id="export_reg_no">
                                           		</div> 
