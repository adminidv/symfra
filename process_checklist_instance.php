...
<html>
<head>
	<title>Process Checklist Instance</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Process Checklist Instance</a>
        </div>
    </div>
  </div>
</div>
			 ...
			 <label id="formSummary" style="color: red;"></label>
				...
				<div class="Bsic_usr_info widget_iner_box">
								...
								<div class="col-md-6">
                                                ...
                                                <div class="input-label"><label >Instance Template</label></div>
                                                <div class="input-feild">
                                                          <input disabled type="number"> <button>...</button>
                                                </div>
                                               
                                           
                                                <div class="input-label"><label >Template Description </label></div>	
                                                <div class="input-feild">
                                                       <input type="text" disabled="" name=""> 
                                                </div>
                                                    
                                                <div class="input-label"><label >Instance Name</label></div>  
                                                <div class="input-feild">
                                                ...
                                                <div class="input-feild">
                                                 ...
                                                 <div class="input-label"><label >Creator  </label></div>  
                                                 <div class="input-feild">
								...
								<div class="col-md-6">
								 				                        <div class="input-label"><label >Instance ID</label></div>
                                                <div class="input-feild">
                                                          <input class="mini_input_field" disabled type="number">
                                                </div>
                                                ...
                                                <div class="input-label"><label >Closing Date </label></div>  
                                                <div class="input-feild">
                                                        <input  type="text">
                                                </div>    
                ...
                <div class="col-md-12"> 
                                      <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#bpmn">BPMN</a></li>
                                        <li><a data-toggle="tab" href="#rmrks">Remarks</a></li>
                                        <li><a data-toggle="tab" href="#atcmhmnts">Attachments</a></li>
                                      </ul>
                </div>
                                      ...
                                      <div class="tab-content">
                                        ...
                                        <div id="bpmn" class="tab-pane fade in active">
                                        </div>

                                        <div id="rmrks" class="tab-pane fade">
                                              <div class="col-md-12 ">
                                               <div class="input-feild">
                                                  <textarea></textarea>
                                               </div>
                                        ...
                                        <div id="atcmhmnts" class="tab-pane fade">
                                            <div align="right" style="margin: 10px 0;">
                                              <button><i class="fa fa-plus"></i></button>
                                            </div>
                                            <table  id="atcmhmntstable" class="display nowrap no-footer" style="width:100%">
