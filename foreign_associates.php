...
if (isset($_POST['submitBtn'])) {
	...
	$website= $_POST['website'];
			...
			$insertQuery = mysqli_query($con, "insert into  foreign_associate (code, associatename, country, city, address, phone, fax, email, website, status) values  ('$code', '$associatename',  '$country', '$city','$address', '$phone', '$fax', '$email', '$website', '$status')") or die( mysqli_error($con));

			 $insertQuery2 = mysqli_query($con, "insert into chainlog (instance, formName, record_id,createBy, createDate) values ('$newID1', 'Foreign', '$SrNo', '$loginUser', '$todayDate') ");

			// echo "The record is inserted successfully.";

			 header("Location: foreign_associate_V1.php?id=" . $code);
...
<html>
<head>
	<title>Foreign Associates</title>
  ...
  <div class="breadCrumb_bar_iner">
    <div class="">
        <div class="btn-group btn-breadcrumb">
          ...
          <a href="hr_add_emp_info.php" class="btn btn-info active">Foreign Associates</a>
        </div>
    </div>
  </div>
</div>
								...
								<div class=" widget_iner_box">
											...
											<div class="form_sec_action_btn col-md-12">
											 ...
											 <div class="col-md-6">
	                                                ...
	                                                <div class="input-feild">
	                                                        <input   type="text" name="associatename" id="associatename" maxlength="40"><span class="steric">*</span>
											...
											<div class="col-md-6">
			                                                ...
			                                                <div class="input-feild">
			                                                        <textarea name="address" id="address" maxlength="50" ></textarea>
